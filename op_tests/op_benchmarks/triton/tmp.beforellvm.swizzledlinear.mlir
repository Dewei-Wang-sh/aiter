...
#linear1 = #ttg.linear<{register = [[0, 1], [0, 2], [0, 4], [8, 32], [128, 0]], lane = [[0, 8], [0, 16], [0, 32], [1, 0], [2, 8], [4, 16]], warp = [[16, 0], [32, 0], [64, 0]], block = []}>
...
module attributes {"ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 8 : i32, ttg.shared = 66528 : i32, ttg.target = "hip:gfx950", "ttg.threads-per-warp" = 64 : i32} {
  ...
  ^bb4:  // pred: ^bb3
    ...
    llvm.intr.assume %true : i1
    %29 = ttg.local_alloc {allocation.offset = 33760 : i32} : () -> !ttg.memdesc<256x64xbf16, #shared, #smem, mutable>
    %30 = ttg.local_alloc {allocation.offset = 0 : i32} : () -> !ttg.memdesc<64x256xbf16, #shared1, #smem, mutable>
