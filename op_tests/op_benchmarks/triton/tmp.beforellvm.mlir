...
module attributes {"ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 8 : i32, ttg.shared = 65536 : i32, ttg.target = "hip:gfx950", "ttg.threads-per-warp" = 64 : i32} {
  ...
  ^bb5:  // pred: ^bb4
    ...
    %35 = tt.make_range {end = 256 : i32, start = 0 : i32} : tensor<256xi32, #ttg.slice<{dim = 1, parent = #blocked1}>>
    %36 = tt.splat %34 : i32 -> tensor<256xi32, #ttg.slice<{dim = 1, parent = #blocked1}>>
    %37 = arith.addi %36, %35 : tensor<256xi32, #ttg.slice<{dim = 1, parent = #blocked1}>>
    %38 = tt.splat %M : i32 -> tensor<256xi32, #ttg.slice<{dim = 1, parent = #blocked1}>>
    %39 = arith.remsi %37, %38 : tensor<256xi32, #ttg.slice<{dim = 1, parent = #blocked1}>>
    ...
    %46 = tt.expand_dims %39 {axis = 1 : i32} : tensor<256xi32, #ttg.slice<{dim = 1, parent = #blocked1}>> -> tensor<256x1xi32, #blocked1>
    %47 = tt.splat %stride_am : i32 -> tensor<256x1xi32, #blocked1>
    %48 = arith.muli %46, %47 : tensor<256x1xi32, #blocked1>
    %49 = tt.expand_dims %32 {axis = 0 : i32} : tensor<64xi32, #ttg.slice<{dim = 0, parent = #blocked1}>> -> tensor<1x64xi32, #blocked1>
    %50 = tt.broadcast %48 : tensor<256x1xi32, #blocked1> -> tensor<256x64xi32, #blocked1>
    %51 = tt.broadcast %49 : tensor<1x64xi32, #blocked1> -> tensor<256x64xi32, #blocked1>
