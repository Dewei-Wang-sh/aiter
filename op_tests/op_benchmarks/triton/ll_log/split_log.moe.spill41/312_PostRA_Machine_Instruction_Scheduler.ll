...
; predecessors: %bb.1
  ...
  BUNDLE implicit-def $vgpr2_vgpr3_vgpr4_vgpr5, implicit-def $vgpr6_vgpr7_vgpr8_vgpr9, implicit-def $vgpr10_vgpr11_vgpr12_vgpr13, implicit-def $vgpr14_vgpr15_vgpr16_vgpr17, implicit killed $vgpr1, implicit $sgpr24_sgpr25_sgpr26_sgpr27, implicit $exec, implicit killed $vgpr18, implicit killed $vgpr19, implicit killed $vgpr0, debug-location !63 :: (dereferenceable load (s128) from %ir.341, align 1, addrspace 8); moe_op_gemm_a8w4.py:404:20 {
...
; predecessors: %bb.43, %bb.44
  ...
  S_CBRANCH_SCC0 %bb.51, implicit killed $scc, debug-location !62; moe_op_gemm_a8w4.py:403:19
