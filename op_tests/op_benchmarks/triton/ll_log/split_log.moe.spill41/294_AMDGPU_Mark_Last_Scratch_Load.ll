# *** IR Dump After AMDGPU Mark Last Scratch Load (amdgpu-mark-last-scratch-load) ***:
...
43272B	  SI_SPILL_AV32_SAVE killed $vgpr240, %stack.11, $sgpr32, 0, implicit $exec :: (store (s32) into %stack.11, addrspace 5)
43296B	  SI_SPILL_AV64_SAVE $vgpr168_vgpr169, %stack.10, $sgpr32, 0, implicit $exec :: (store (s64) into %stack.10, align 4, addrspace 5)
43312B	  SI_SPILL_AV64_SAVE $vgpr166_vgpr167, %stack.9, $sgpr32, 0, implicit $exec :: (store (s64) into %stack.9, align 4, addrspace 5)
43328B	  SI_SPILL_AV64_SAVE $vgpr164_vgpr165, %stack.8, $sgpr32, 0, implicit $exec :: (store (s64) into %stack.8, align 4, addrspace 5)
43344B	  SI_SPILL_AV64_SAVE $vgpr162_vgpr163, %stack.7, $sgpr32, 0, implicit $exec :: (store (s64) into %stack.7, align 4, addrspace 5)
43352B	  SI_SPILL_AV32_SAVE killed $vgpr151, %stack.6, $sgpr32, 0, implicit $exec :: (store (s32) into %stack.6, addrspace 5)
43368B	  SI_SPILL_AV64_SAVE $vgpr160_vgpr161, %stack.5, $sgpr32, 0, implicit $exec :: (store (s64) into %stack.5, align 4, addrspace 5)
43384B	  SI_SPILL_AV32_SAVE killed $vgpr237, %stack.4, $sgpr32, 0, implicit $exec :: (store (s32) into %stack.4, addrspace 5)
43392B	  SI_SPILL_AV64_SAVE killed $vgpr234_vgpr235, %stack.3, $sgpr32, 0, implicit $exec :: (store (s64) into %stack.3, align 4, addrspace 5)
43400B	  SI_SPILL_AV32_SAVE killed $vgpr233, %stack.2, $sgpr32, 0, implicit $exec :: (store (s32) into %stack.2, addrspace 5)
43408B	  SI_SPILL_AV32_SAVE killed $vgpr232, %stack.1, $sgpr32, 0, implicit $exec :: (store (s32) into %stack.1, addrspace 5)
43416B	  SI_SPILL_AV32_SAVE killed $vgpr231, %stack.0, $sgpr32, 0, implicit $exec :: (store (s32) into %stack.0, addrspace 5)
...
43508B	  SI_SPILL_AV32_SAVE $vgpr92, %stack.12, $sgpr32, 0, implicit $exec :: (store (s32) into %stack.12, addrspace 5)
...
43704B	  SI_SPILL_AV64_SAVE killed $vgpr0_vgpr1, %stack.13, $sgpr32, 0, implicit $exec, debug-location !62 :: (store (s64) into %stack.13, align 4, addrspace 5); moe_op_gemm_a8w4.py:403:19
...
43768B	  SI_SPILL_AV64_SAVE killed $vgpr0_vgpr1, %stack.14, $sgpr32, 0, implicit $exec, debug-location !62 :: (store (s64) into %stack.14, align 4, addrspace 5); moe_op_gemm_a8w4.py:403:19
...
43832B	  SI_SPILL_AV64_SAVE killed $vgpr0_vgpr1, %stack.15, $sgpr32, 0, implicit $exec, debug-location !62 :: (store (s64) into %stack.15, align 4, addrspace 5); moe_op_gemm_a8w4.py:403:19
...
43896B	  SI_SPILL_AV64_SAVE killed $vgpr0_vgpr1, %stack.16, $sgpr32, 0, implicit $exec, debug-location !62 :: (store (s64) into %stack.16, align 4, addrspace 5); moe_op_gemm_a8w4.py:403:19
...
43960B	  SI_SPILL_AV64_SAVE killed $vgpr0_vgpr1, %stack.17, $sgpr32, 0, implicit $exec, debug-location !62 :: (store (s64) into %stack.17, align 4, addrspace 5); moe_op_gemm_a8w4.py:403:19
...
51128B	  renamable $vgpr4_vgpr5 = SI_SPILL_AV64_RESTORE %stack.17, $sgpr32, 0, implicit $exec, debug-location !82 :: (load (s64) from %stack.17, align 4, addrspace 5); moe_op_gemm_a8w4.py:429:17
...
51144B	  renamable $vgpr6_vgpr7 = SI_SPILL_AV64_RESTORE %stack.16, $sgpr32, 0, implicit $exec, debug-location !82 :: (load (s64) from %stack.16, align 4, addrspace 5); moe_op_gemm_a8w4.py:429:17
...
51160B	  renamable $vgpr8_vgpr9 = SI_SPILL_AV64_RESTORE %stack.15, $sgpr32, 0, implicit $exec, debug-location !82 :: (load (s64) from %stack.15, align 4, addrspace 5); moe_op_gemm_a8w4.py:429:17
...
51176B	  renamable $vgpr18_vgpr19 = SI_SPILL_AV64_RESTORE %stack.14, $sgpr32, 0, implicit $exec, debug-location !82 :: (load (s64) from %stack.14, align 4, addrspace 5); moe_op_gemm_a8w4.py:429:17
...
51192B	  renamable $vgpr20_vgpr21 = SI_SPILL_AV64_RESTORE %stack.13, $sgpr32, 0, implicit $exec, debug-location !82 :: (load (s64) from %stack.13, align 4, addrspace 5); moe_op_gemm_a8w4.py:429:17
...
51240B	  SI_SPILL_AV128_SAVE killed $vgpr32_vgpr33_vgpr34_vgpr35, %stack.18, $sgpr32, 0, implicit $exec, debug-location !63 :: (store (s128) into %stack.18, align 4, addrspace 5); moe_op_gemm_a8w4.py:404:20
...
51256B	  SI_SPILL_AV128_SAVE killed $vgpr32_vgpr33_vgpr34_vgpr35, %stack.19, $sgpr32, 0, implicit $exec, debug-location !63 :: (store (s128) into %stack.19, align 4, addrspace 5); moe_op_gemm_a8w4.py:404:20
...
51272B	  SI_SPILL_AV128_SAVE killed $vgpr32_vgpr33_vgpr34_vgpr35, %stack.20, $sgpr32, 0, implicit $exec, debug-location !63 :: (store (s128) into %stack.20, align 4, addrspace 5); moe_op_gemm_a8w4.py:404:20
...
67944B	  renamable $vgpr0_vgpr1_vgpr2_vgpr3 = SI_SPILL_AV128_RESTORE %stack.18, $sgpr32, 0, implicit $exec, debug-location !63 :: (load (s128) from %stack.18, align 4, addrspace 5); moe_op_gemm_a8w4.py:404:20
...
67960B	  renamable $vgpr0_vgpr1_vgpr2_vgpr3 = SI_SPILL_AV128_RESTORE %stack.19, $sgpr32, 0, implicit $exec, debug-location !63 :: (load (s128) from %stack.19, align 4, addrspace 5); moe_op_gemm_a8w4.py:404:20
...
67976B	  renamable $vgpr0_vgpr1_vgpr2_vgpr3 = SI_SPILL_AV128_RESTORE %stack.20, $sgpr32, 0, implicit $exec, debug-location !63 :: (load (s128) from %stack.20, align 4, addrspace 5); moe_op_gemm_a8w4.py:404:20
...
70340B	  renamable $vgpr240 = SI_SPILL_AV32_RESTORE %stack.11, $sgpr32, 0, implicit $exec :: (load (s32) from %stack.11, addrspace 5)
70344B	  renamable $vgpr230 = V_LSHRREV_B32_e32 4, $vgpr240, implicit $exec
72396B	  renamable $vgpr231 = SI_SPILL_AV32_RESTORE %stack.0, $sgpr32, 0, implicit $exec :: (load (s32) from %stack.0, addrspace 5)
72404B	  renamable $vgpr232 = SI_SPILL_AV32_RESTORE %stack.1, $sgpr32, 0, implicit $exec :: (load (s32) from %stack.1, addrspace 5)
72408B	  renamable $vgpr233 = SI_SPILL_AV32_RESTORE %stack.2, $sgpr32, 0, implicit $exec :: (load (s32) from %stack.2, addrspace 5)
72416B	  renamable $vgpr234_vgpr235 = SI_SPILL_AV64_RESTORE %stack.3, $sgpr32, 0, implicit $exec :: (load (s64) from %stack.3, align 4, addrspace 5)
72420B	  renamable $vgpr237 = SI_SPILL_AV32_RESTORE %stack.4, $sgpr32, 0, implicit $exec :: (load (s32) from %stack.4, addrspace 5)
...
72452B	  renamable $vgpr160_vgpr161 = SI_SPILL_AV64_RESTORE %stack.5, $sgpr32, 0, implicit $exec :: (load (s64) from %stack.5, align 4, addrspace 5)
72464B	  renamable $vgpr151 = SI_SPILL_AV32_RESTORE %stack.6, $sgpr32, 0, implicit $exec :: (load (s32) from %stack.6, addrspace 5)
72468B	  renamable $vgpr162_vgpr163 = SI_SPILL_AV64_RESTORE %stack.7, $sgpr32, 0, implicit $exec :: (load (s64) from %stack.7, align 4, addrspace 5)
72480B	  renamable $vgpr164_vgpr165 = SI_SPILL_AV64_RESTORE %stack.8, $sgpr32, 0, implicit $exec :: (load (s64) from %stack.8, align 4, addrspace 5)
72496B	  renamable $vgpr166_vgpr167 = SI_SPILL_AV64_RESTORE %stack.9, $sgpr32, 0, implicit $exec :: (load (s64) from %stack.9, align 4, addrspace 5)
72512B	  renamable $vgpr168_vgpr169 = SI_SPILL_AV64_RESTORE %stack.10, $sgpr32, 0, implicit $exec :: (load (s64) from %stack.10, align 4, addrspace 5)
72524B	  renamable $vgpr92 = SI_SPILL_AV32_RESTORE %stack.12, $sgpr32, 0, implicit $exec :: (load (s32) from %stack.12, addrspace 5)
