...
; predecessors: %bb.55
  ...
  SCRATCH_STORE_DWORDX2_ST $vgpr168_vgpr169, 148, 0, implicit $exec, implicit $flat_scr :: (store (s64) into %stack.18, align 4, addrspace 5)
  SCRATCH_STORE_DWORDX2_ST $vgpr166_vgpr167, 140, 0, implicit $exec, implicit $flat_scr :: (store (s64) into %stack.17, align 4, addrspace 5)
  SCRATCH_STORE_DWORDX2_ST $vgpr164_vgpr165, 132, 0, implicit $exec, implicit $flat_scr :: (store (s64) into %stack.16, align 4, addrspace 5)
  SCRATCH_STORE_DWORDX2_ST $vgpr162_vgpr163, 124, 0, implicit $exec, implicit $flat_scr :: (store (s64) into %stack.15, align 4, addrspace 5)
  SCRATCH_STORE_DWORD_ST killed $vgpr151, 120, 0, implicit $exec, implicit $flat_scr :: (store (s32) into %stack.14, addrspace 5)
  SCRATCH_STORE_DWORDX2_ST $vgpr160_vgpr161, 112, 0, implicit $exec, implicit $flat_scr :: (store (s64) into %stack.13, align 4, addrspace 5)
  ...
  SCRATCH_STORE_DWORD_ST $vgpr92, 160, 0, implicit $exec, implicit $flat_scr :: (store (s32) into %stack.20, addrspace 5)
