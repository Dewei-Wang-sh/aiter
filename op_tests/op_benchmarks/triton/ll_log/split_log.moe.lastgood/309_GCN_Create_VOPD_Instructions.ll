...
bb.0 (%ir-block.30):
  ...
  BUNDLE implicit-def $sgpr2_sgpr3, implicit-def $sgpr6_sgpr7, implicit $sgpr0_sgpr1 {
  ...
  renamable $vgpr2 = V_SUB_U32_e32 killed $sgpr2, killed $vgpr2, implicit $exec
  ...
  renamable $sgpr6_sgpr7 = S_CSELECT_B64 -1, 0, implicit killed $scc
  ...
  S_CBRANCH_VCCZ %bb.52, implicit killed $vcc
...
; predecessors: %bb.0
  ...
  renamable $sgpr6 = S_MIN_I32 renamable $sgpr9, killed renamable $sgpr6, implicit-def dead $scc
  renamable $sgpr7 = nsw S_MUL_I32 killed renamable $sgpr7, killed renamable $sgpr9
  ...
  renamable $sgpr6 = S_CSELECT_B32 killed renamable $sgpr9, killed renamable $sgpr6, implicit killed $scc
  renamable $sgpr9 = S_SUB_I32 renamable $sgpr6, renamable $sgpr2, implicit-def dead $scc
  S_CMP_GE_U32 renamable $sgpr6, killed renamable $sgpr2, implicit-def $scc
  renamable $sgpr2 = S_CSELECT_B32 killed renamable $sgpr9, killed renamable $sgpr6, implicit killed $scc
  ...
  renamable $sgpr11 = S_CSELECT_B32 killed renamable $sgpr17, killed renamable $sgpr11, implicit killed $scc
  renamable $sgpr16 = S_ADD_I32 renamable $sgpr9, 1, implicit-def dead $scc
  S_CMP_GE_U32 killed renamable $sgpr11, killed renamable $sgpr3, implicit-def $scc
  renamable $sgpr3 = S_CSELECT_B32 killed renamable $sgpr16, killed renamable $sgpr9, implicit killed $scc
  ...
  renamable $sgpr6 = S_CSELECT_B32 killed renamable $sgpr18, killed renamable $sgpr6, implicit killed $scc
  renamable $sgpr18 = S_SUB_I32 renamable $sgpr6, renamable $sgpr4, implicit-def dead $scc
  S_CMP_GE_U32 renamable $sgpr6, renamable $sgpr4, implicit-def $scc
  renamable $sgpr6 = S_CSELECT_B32 killed renamable $sgpr18, killed renamable $sgpr6, implicit killed $scc
  ...
  renamable $sgpr2 = S_ADD_U32 killed renamable $sgpr2, killed renamable $sgpr16, implicit-def $scc
  renamable $sgpr3 = S_ADDC_U32 killed renamable $sgpr3, killed renamable $sgpr17, implicit-def dead $scc, implicit killed $scc
  ...
  S_CBRANCH_VCCNZ %bb.52, implicit killed $vcc
...
; predecessors: %bb.1
  ...
  renamable $vgpr174 = GLOBAL_LOAD_DWORD_SADDR killed renamable $sgpr18_sgpr19, renamable $vgpr4, 0, 0, implicit $exec :: (load (s32) from %ir.192, addrspace 1)
  ...
  renamable $sgpr2 = S_CSELECT_B32 killed renamable $sgpr7, killed renamable $sgpr2, implicit killed $scc
  ...
  renamable $sgpr2 = S_CSELECT_B32 killed renamable $sgpr7, killed renamable $sgpr3, implicit killed $scc
  renamable $sgpr17 = S_AND_B32 killed renamable $sgpr17, 65535, implicit-def dead $scc
  ...
  renamable $sgpr4 = S_ADD_I32 killed renamable $sgpr23, 255, implicit-def dead $scc
  ...
  BUNDLE implicit-def $vgpr6, implicit-def $vgpr7, implicit-def $vgpr8, implicit-def $vgpr9, implicit killed $vgpr2, implicit killed $sgpr16_sgpr17_sgpr18_sgpr19, implicit $exec, implicit killed $vgpr3, implicit killed $vgpr4, implicit killed $vgpr5 {
    renamable $vgpr6 = BUFFER_LOAD_DWORD_OFFEN killed renamable $vgpr2, renamable $sgpr16_sgpr17_sgpr18_sgpr19, 0, 0, 0, 0, implicit $exec :: (dereferenceable load (s32) from %ir.316, align 1, addrspace 8)
    renamable $vgpr7 = BUFFER_LOAD_DWORD_OFFEN killed renamable $vgpr3, renamable $sgpr16_sgpr17_sgpr18_sgpr19, 0, 0, 0, 0, implicit $exec :: (dereferenceable load (s32) from %ir.316, align 1, addrspace 8)
    renamable $vgpr8 = BUFFER_LOAD_DWORD_OFFEN killed renamable $vgpr4, renamable $sgpr16_sgpr17_sgpr18_sgpr19, 0, 0, 0, 0, implicit $exec :: (dereferenceable load (s32) from %ir.316, align 1, addrspace 8)
    renamable $vgpr9 = BUFFER_LOAD_DWORD_OFFEN killed renamable $vgpr5, killed renamable $sgpr16_sgpr17_sgpr18_sgpr19, 0, 0, 0, 0, implicit $exec :: (dereferenceable load (s32) from %ir.316, align 1, addrspace 8)
  }
  ...
  renamable $sgpr2_sgpr3 = S_CSELECT_B64 -1, 0, implicit killed $scc
  renamable $sgpr25 = S_AND_B32 killed renamable $sgpr25, 65535, implicit-def dead $scc
  ...
  BUNDLE implicit-def $vgpr2_vgpr3_vgpr4_vgpr5, implicit-def $vgpr6_vgpr7_vgpr8_vgpr9, implicit-def $vgpr10_vgpr11_vgpr12_vgpr13, implicit-def $vgpr14_vgpr15_vgpr16_vgpr17, implicit killed $vgpr18, implicit $sgpr24_sgpr25_sgpr26_sgpr27, implicit $exec, implicit killed $vgpr19, implicit killed $vgpr20, implicit killed $vgpr21 {
    renamable $vgpr2_vgpr3_vgpr4_vgpr5 = BUFFER_LOAD_DWORDX4_OFFEN killed renamable $vgpr18, renamable $sgpr24_sgpr25_sgpr26_sgpr27, 0, 0, 0, 0, implicit $exec :: (dereferenceable load (s128) from %ir.341, align 1, addrspace 8)
    renamable $vgpr6_vgpr7_vgpr8_vgpr9 = BUFFER_LOAD_DWORDX4_OFFEN killed renamable $vgpr19, renamable $sgpr24_sgpr25_sgpr26_sgpr27, 0, 0, 0, 0, implicit $exec :: (dereferenceable load (s128) from %ir.341, align 1, addrspace 8)
    renamable $vgpr10_vgpr11_vgpr12_vgpr13 = BUFFER_LOAD_DWORDX4_OFFEN killed renamable $vgpr20, renamable $sgpr24_sgpr25_sgpr26_sgpr27, 0, 0, 0, 0, implicit $exec :: (dereferenceable load (s128) from %ir.341, align 1, addrspace 8)
    renamable $vgpr14_vgpr15_vgpr16_vgpr17 = BUFFER_LOAD_DWORDX4_OFFEN killed renamable $vgpr21, renamable $sgpr24_sgpr25_sgpr26_sgpr27, 0, 0, 0, 0, implicit $exec :: (dereferenceable load (s128) from %ir.341, align 1, addrspace 8)
  }
  ...
  renamable $sgpr6_sgpr7 = S_CSELECT_B64 -1, 0, implicit killed $scc
  $sgpr8_sgpr9 = S_AND_SAVEEXEC_B64 killed $sgpr6_sgpr7, implicit-def $exec, implicit-def $scc, implicit $exec
...
; predecessors: %bb.2
  ...
  renamable $sgpr11 = S_ADDC_U32 renamable $sgpr23, renamable $sgpr6, implicit-def dead $scc, implicit killed $scc
  ...
  renamable $sgpr17 = S_SUBB_U32 0, renamable $sgpr11, implicit-def dead $scc, implicit killed $scc
  ...
  renamable $sgpr19 = S_ADDC_U32 0, killed renamable $sgpr19, implicit-def dead $scc, implicit killed $scc
  ...
  renamable $sgpr19 = S_ADDC_U32 killed renamable $sgpr19, killed renamable $sgpr36, implicit-def $scc, implicit killed $scc
  renamable $sgpr30 = S_ADDC_U32 killed renamable $sgpr33, 0, implicit-def dead $scc, implicit killed $scc
  ...
  renamable $sgpr19 = S_ADDC_U32 0, killed renamable $sgpr30, implicit-def dead $scc, implicit killed $scc
  renamable $sgpr30 = S_ADD_U32 killed renamable $sgpr6, killed renamable $sgpr7, implicit-def $scc
  renamable $sgpr6_sgpr7 = S_CSELECT_B64 -1, 0, implicit killed $scc
  S_CMP_LG_U64 killed renamable $sgpr6_sgpr7, 0, implicit-def $scc
  renamable $sgpr18 = S_ADDC_U32 killed renamable $sgpr18, killed renamable $sgpr19, implicit-def dead $scc, implicit killed $scc
  ...
  renamable $sgpr31 = S_ADDC_U32 0, killed renamable $sgpr31, implicit-def dead $scc, implicit killed $scc
  ...
  renamable $sgpr16 = S_ADDC_U32 killed renamable $sgpr31, killed renamable $sgpr17, implicit-def $scc, implicit killed $scc
  renamable $sgpr7 = S_ADDC_U32 killed renamable $sgpr7, 0, implicit-def dead $scc, implicit killed $scc
  ...
  renamable $sgpr16 = S_ADDC_U32 0, killed renamable $sgpr7, implicit-def dead $scc, implicit killed $scc
  ...
  renamable $sgpr16 = S_ADDC_U32 killed renamable $sgpr18, killed renamable $sgpr16, implicit-def dead $scc, implicit killed $scc
  renamable $vgpr28 = V_XOR_B32_e32 killed $vgpr18, $vgpr22, implicit $exec
  renamable $vgpr23 = V_XOR_B32_e32 killed $vgpr19, $vgpr22, implicit $exec
  ...
  dead renamable $vgpr18 = V_ADD_CO_U32_e32 killed $vgpr18, killed $vgpr26, implicit-def $vcc, implicit $exec
  renamable $vgpr24_vgpr25, dead renamable $sgpr6_sgpr7 = V_MAD_U64_U32_e64 $vgpr23, killed $sgpr16, 0, 0, implicit $exec
  renamable $vgpr20 = V_ADDC_U32_e32 killed $vgpr19, killed $vgpr27, implicit-def $vcc, implicit killed $vcc, implicit $exec
  renamable $vgpr25 = V_ADDC_U32_e32 0, killed $vgpr25, implicit-def dead $vcc, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr21 = V_MUL_LO_U32_e64 $sgpr10, killed $vgpr19, implicit $exec
  renamable $vgpr18_vgpr19, dead renamable $sgpr6_sgpr7 = V_MAD_U64_U32_e64 $sgpr10, killed $vgpr18, 0, 0, implicit $exec
  renamable $vgpr19 = V_ADD3_U32_e64 killed $vgpr19, killed $vgpr21, killed $vgpr20, implicit $exec
  ...
  renamable $vgpr24, dead renamable $sgpr6_sgpr7 = V_SUBREV_CO_U32_e64 killed $sgpr10, $vgpr21, 0, implicit $exec
...
; predecessors: %bb.3, %bb.4
  ...
  renamable $vgpr133 = V_MUL_LO_U32_e64 $vgpr175, killed $sgpr6, implicit $exec
  ...
  renamable $sgpr29 = S_AND_B32 killed renamable $sgpr29, 65535, implicit-def dead $scc
...
; predecessors: %bb.5
  ...
  $sgpr7 = S_MOV_B32 $sgpr6
  renamable $sgpr9 = S_ADDC_U32 renamable $sgpr23, renamable $sgpr6, implicit-def dead $scc, implicit killed $scc
  ...
  renamable $sgpr9 = S_SUBB_U32 0, renamable $sgpr37, implicit-def dead $scc, implicit killed $scc
  ...
  renamable $sgpr33 = S_ADDC_U32 0, killed renamable $sgpr33, implicit-def dead $scc, implicit killed $scc
  ...
  renamable $sgpr33 = S_ADDC_U32 killed renamable $sgpr33, killed renamable $sgpr41, implicit-def $scc, implicit killed $scc
  renamable $sgpr38 = S_ADDC_U32 killed renamable $sgpr40, 0, implicit-def dead $scc, implicit killed $scc
  ...
  renamable $sgpr33 = S_ADDC_U32 0, killed renamable $sgpr38, implicit-def dead $scc, implicit killed $scc
  renamable $sgpr38 = S_ADD_U32 killed renamable $sgpr6, killed renamable $sgpr7, implicit-def $scc
  renamable $sgpr6_sgpr7 = S_CSELECT_B64 -1, 0, implicit killed $scc
  S_CMP_LG_U64 killed renamable $sgpr6_sgpr7, 0, implicit-def $scc
  renamable $sgpr10 = S_ADDC_U32 killed renamable $sgpr10, killed renamable $sgpr33, implicit-def dead $scc, implicit killed $scc
  ...
  renamable $sgpr39 = S_ADDC_U32 0, killed renamable $sgpr39, implicit-def dead $scc, implicit killed $scc
  ...
  renamable $sgpr8 = S_ADDC_U32 killed renamable $sgpr39, killed renamable $sgpr9, implicit-def $scc, implicit killed $scc
  renamable $sgpr7 = S_ADDC_U32 killed renamable $sgpr7, 0, implicit-def dead $scc, implicit killed $scc
  ...
  renamable $sgpr8 = S_ADDC_U32 0, killed renamable $sgpr7, implicit-def dead $scc, implicit killed $scc
  ...
  renamable $sgpr8 = S_ADDC_U32 killed renamable $sgpr10, killed renamable $sgpr8, implicit-def dead $scc, implicit killed $scc
  renamable $vgpr23 = V_XOR_B32_e32 killed $vgpr18, $vgpr22, implicit $exec
  renamable $vgpr21 = V_XOR_B32_e32 killed $vgpr19, $vgpr22, implicit $exec
  ...
  dead renamable $vgpr18 = V_ADD_CO_U32_e32 killed $vgpr18, killed $vgpr28, implicit-def $vcc, implicit $exec
  renamable $vgpr26_vgpr27, dead renamable $sgpr6_sgpr7 = V_MAD_U64_U32_e64 $vgpr21, killed $sgpr8, 0, 0, implicit $exec
  renamable $vgpr24 = V_ADDC_U32_e32 killed $vgpr19, killed $vgpr29, implicit-def $vcc, implicit killed $vcc, implicit $exec
  renamable $vgpr27 = V_ADDC_U32_e32 0, killed $vgpr27, implicit-def dead $vcc, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr25 = V_MUL_LO_U32_e64 $sgpr36, killed $vgpr19, implicit $exec
  renamable $vgpr18_vgpr19, dead renamable $sgpr6_sgpr7 = V_MAD_U64_U32_e64 $sgpr36, killed $vgpr18, 0, 0, implicit $exec
  renamable $vgpr19 = V_ADD3_U32_e64 killed $vgpr19, killed $vgpr25, killed $vgpr24, implicit $exec
  ...
  V_CMP_LE_U32_e32 killed $sgpr36, $vgpr18, implicit-def $vcc, implicit $exec
  ...
  renamable $vgpr18 = V_CNDMASK_B32_e32 killed $vgpr18, killed $vgpr21, implicit $vcc, implicit $exec
  renamable $vgpr19 = V_CNDMASK_B32_e32 killed $vgpr19, killed $vgpr23, implicit killed $vcc, implicit $exec
  renamable $vgpr18 = V_XOR_B32_e32 killed $vgpr18, $vgpr22, implicit $exec
...
; predecessors: %bb.8
  ...
  renamable $vgpr21 = V_XOR_B32_e32 killed $vgpr23, $vgpr26, implicit $exec
  ...
  dead renamable $vgpr22 = V_ADD_CO_U32_e32 killed $vgpr22, killed $vgpr30, implicit-def $vcc, implicit $exec
  renamable $vgpr28_vgpr29, dead renamable $sgpr6_sgpr7 = V_MAD_U64_U32_e64 $vgpr21, killed $sgpr8, 0, 0, implicit $exec
  renamable $vgpr24 = V_ADDC_U32_e32 killed $vgpr23, killed $vgpr31, implicit-def $vcc, implicit killed $vcc, implicit $exec
  renamable $vgpr29 = V_ADDC_U32_e32 0, killed $vgpr29, implicit-def dead $vcc, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr25 = V_MUL_LO_U32_e64 $sgpr36, killed $vgpr23, implicit $exec
  renamable $vgpr22_vgpr23, dead renamable $sgpr6_sgpr7 = V_MAD_U64_U32_e64 $sgpr36, killed $vgpr22, 0, 0, implicit $exec
  renamable $vgpr23 = V_ADD3_U32_e64 killed $vgpr23, killed $vgpr25, killed $vgpr24, implicit $exec
  ...
  renamable $vgpr23 = V_CNDMASK_B32_e64 0, 0, 0, -1, killed $vcc, implicit $exec
  V_CMP_LE_U32_e32 killed $sgpr36, $vgpr22, implicit-def $vcc, implicit $exec
  ...
  renamable $vgpr22 = V_CNDMASK_B32_e32 killed $vgpr22, killed $vgpr23, implicit $vcc, implicit $exec
...
; predecessors: %bb.11
  ...
  S_CMP_LG_U64 killed renamable $sgpr6_sgpr7, 0, implicit-def $scc
  renamable $sgpr8 = S_ADDC_U32 killed renamable $sgpr10, killed renamable $sgpr8, implicit-def dead $scc, implicit killed $scc
  renamable $vgpr21 = V_XOR_B32_e32 killed $vgpr25, $vgpr28, implicit $exec
  ...
  dead renamable $vgpr24 = V_ADD_CO_U32_e32 killed $vgpr24, killed $vgpr32, implicit-def $vcc, implicit $exec
  renamable $vgpr30_vgpr31, dead renamable $sgpr6_sgpr7 = V_MAD_U64_U32_e64 $vgpr21, killed $sgpr8, 0, 0, implicit $exec
  renamable $vgpr26 = V_ADDC_U32_e32 killed $vgpr25, killed $vgpr33, implicit-def $vcc, implicit killed $vcc, implicit $exec
  renamable $vgpr31 = V_ADDC_U32_e32 0, killed $vgpr31, implicit-def dead $vcc, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr27 = V_MUL_LO_U32_e64 $sgpr36, killed $vgpr25, implicit $exec
  renamable $vgpr24_vgpr25, dead renamable $sgpr6_sgpr7 = V_MAD_U64_U32_e64 $sgpr36, killed $vgpr24, 0, 0, implicit $exec
  renamable $vgpr25 = V_ADD3_U32_e64 killed $vgpr25, killed $vgpr27, killed $vgpr26, implicit $exec
  ...
  renamable $vgpr25 = V_CNDMASK_B32_e64 0, 0, 0, -1, killed $vcc, implicit $exec
  V_CMP_LE_U32_e32 killed $sgpr36, $vgpr24, implicit-def $vcc, implicit $exec
  ...
  renamable $vgpr24 = V_CNDMASK_B32_e32 killed $vgpr24, killed $vgpr25, implicit $vcc, implicit $exec
  renamable $vgpr21 = V_CNDMASK_B32_e32 killed $vgpr21, killed $vgpr26, implicit killed $vcc, implicit $exec
...
; predecessors: %bb.14
  ...
  S_CMP_LG_U64 killed renamable $sgpr6_sgpr7, 0, implicit-def $scc
  renamable $sgpr8 = S_ADDC_U32 killed renamable $sgpr10, killed renamable $sgpr8, implicit-def dead $scc, implicit killed $scc
  renamable $vgpr21 = V_XOR_B32_e32 killed $vgpr25, $vgpr30, implicit $exec
  ...
  dead renamable $vgpr24 = V_ADD_CO_U32_e32 killed $vgpr24, killed $vgpr34, implicit-def $vcc, implicit $exec
  renamable $vgpr32_vgpr33, dead renamable $sgpr6_sgpr7 = V_MAD_U64_U32_e64 $vgpr21, killed $sgpr8, 0, 0, implicit $exec
  renamable $vgpr28 = V_ADDC_U32_e32 killed $vgpr25, killed $vgpr35, implicit-def $vcc, implicit killed $vcc, implicit $exec
  renamable $vgpr33 = V_ADDC_U32_e32 0, killed $vgpr33, implicit-def dead $vcc, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr29 = V_MUL_LO_U32_e64 $sgpr36, killed $vgpr25, implicit $exec
  renamable $vgpr24_vgpr25, dead renamable $sgpr6_sgpr7 = V_MAD_U64_U32_e64 $sgpr36, killed $vgpr24, 0, 0, implicit $exec
  renamable $vgpr25 = V_ADD3_U32_e64 killed $vgpr25, killed $vgpr29, killed $vgpr28, implicit $exec
  ...
  renamable $vgpr24 = V_CNDMASK_B32_e32 killed $vgpr24, killed $vgpr25, implicit $vcc, implicit $exec
  renamable $vgpr21 = V_CNDMASK_B32_e32 killed $vgpr21, killed $vgpr28, implicit killed $vcc, implicit $exec
...
; predecessors: %bb.17
  ...
  dead renamable $vgpr24 = V_ADD_CO_U32_e32 killed $vgpr24, killed $vgpr36, implicit-def $vcc, implicit $exec
  renamable $vgpr34_vgpr35, dead renamable $sgpr6_sgpr7 = V_MAD_U64_U32_e64 $vgpr21, killed $sgpr8, 0, 0, implicit $exec
  renamable $vgpr32 = V_ADDC_U32_e32 killed $vgpr25, killed $vgpr37, implicit-def $vcc, implicit killed $vcc, implicit $exec
  renamable $vgpr35 = V_ADDC_U32_e32 0, killed $vgpr35, implicit-def dead $vcc, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr33 = V_MUL_LO_U32_e64 $sgpr36, killed $vgpr25, implicit $exec
  renamable $vgpr24_vgpr25, dead renamable $sgpr6_sgpr7 = V_MAD_U64_U32_e64 $sgpr36, killed $vgpr24, 0, 0, implicit $exec
  renamable $vgpr25 = V_ADD3_U32_e64 killed $vgpr25, killed $vgpr33, killed $vgpr32, implicit $exec
  ...
  renamable $vgpr24 = V_CNDMASK_B32_e32 killed $vgpr24, killed $vgpr25, implicit $vcc, implicit $exec
  renamable $vgpr21 = V_CNDMASK_B32_e32 killed $vgpr21, killed $vgpr31, implicit killed $vcc, implicit $exec
  renamable $vgpr24 = V_XOR_B32_e32 killed $vgpr24, $vgpr30, implicit $exec
  renamable $vgpr21 = V_XOR_B32_e32 killed $vgpr21, $vgpr30, implicit $exec
...
; predecessors: %bb.18, %bb.19
  ...
  $sgpr8_sgpr9 = S_AND_SAVEEXEC_B64 killed $sgpr6_sgpr7, implicit-def $exec, implicit-def $scc, implicit $exec
  renamable $sgpr16_sgpr17 = S_XOR_B64 $exec, killed renamable $sgpr8_sgpr9, implicit-def dead $scc
  S_CBRANCH_EXECZ %bb.21, implicit $exec
...
; predecessors: %bb.20
  ...
  dead renamable $vgpr24 = V_ADD_CO_U32_e32 killed $vgpr24, killed $vgpr38, implicit-def $vcc, implicit $exec
  renamable $vgpr36_vgpr37, dead renamable $sgpr6_sgpr7 = V_MAD_U64_U32_e64 $vgpr21, killed $sgpr8, 0, 0, implicit $exec
  renamable $vgpr32 = V_ADDC_U32_e32 killed $vgpr25, killed $vgpr39, implicit-def $vcc, implicit killed $vcc, implicit $exec
  renamable $vgpr37 = V_ADDC_U32_e32 0, killed $vgpr37, implicit-def dead $vcc, implicit killed $vcc, implicit $exec
...
; predecessors: %bb.21, %bb.22
  ...
  $sgpr8_sgpr9 = S_AND_SAVEEXEC_B64 killed $sgpr6_sgpr7, implicit-def $exec, implicit-def $scc, implicit $exec
  renamable $sgpr16_sgpr17 = S_XOR_B64 $exec, killed renamable $sgpr8_sgpr9, implicit-def dead $scc
  S_CBRANCH_EXECZ %bb.24, implicit $exec
...
; predecessors: %bb.23
  ...
  dead renamable $vgpr24 = V_ADD_CO_U32_e32 killed $vgpr24, killed $vgpr40, implicit-def $vcc, implicit $exec
  renamable $vgpr38_vgpr39, dead renamable $sgpr6_sgpr7 = V_MAD_U64_U32_e64 $vgpr21, killed $sgpr8, 0, 0, implicit $exec
  renamable $vgpr32 = V_ADDC_U32_e32 killed $vgpr25, killed $vgpr41, implicit-def $vcc, implicit killed $vcc, implicit $exec
  renamable $vgpr39 = V_ADDC_U32_e32 0, killed $vgpr39, implicit-def dead $vcc, implicit killed $vcc, implicit $exec
...
; predecessors: %bb.26
  ...
  renamable $sgpr9 = S_SUBB_U32 0, renamable $sgpr17, implicit-def dead $scc, implicit killed $scc
  ...
  renamable $sgpr36 = S_ADDC_U32 0, killed renamable $sgpr36, implicit-def dead $scc, implicit killed $scc
  ...
  renamable $sgpr36 = S_ADDC_U32 killed renamable $sgpr36, killed renamable $sgpr40, implicit-def $scc, implicit killed $scc
  renamable $sgpr37 = S_ADDC_U32 killed renamable $sgpr39, 0, implicit-def dead $scc, implicit killed $scc
  ...
  renamable $sgpr36 = S_ADDC_U32 0, killed renamable $sgpr37, implicit-def dead $scc, implicit killed $scc
  renamable $sgpr37 = S_ADD_U32 killed renamable $sgpr6, killed renamable $sgpr7, implicit-def $scc
  renamable $sgpr6_sgpr7 = S_CSELECT_B64 -1, 0, implicit killed $scc
  S_CMP_LG_U64 killed renamable $sgpr6_sgpr7, 0, implicit-def $scc
  renamable $sgpr33 = S_ADDC_U32 killed renamable $sgpr33, killed renamable $sgpr36, implicit-def dead $scc, implicit killed $scc
  ...
  renamable $sgpr38 = S_ADDC_U32 0, killed renamable $sgpr38, implicit-def dead $scc, implicit killed $scc
  ...
  renamable $sgpr8 = S_ADDC_U32 killed renamable $sgpr38, killed renamable $sgpr9, implicit-def $scc, implicit killed $scc
  renamable $sgpr7 = S_ADDC_U32 killed renamable $sgpr7, 0, implicit-def dead $scc, implicit killed $scc
  ...
  renamable $sgpr8 = S_ADDC_U32 killed renamable $sgpr33, killed renamable $sgpr8, implicit-def dead $scc, implicit killed $scc
  renamable $vgpr40 = V_XOR_B32_e32 killed $vgpr20, $vgpr24, implicit $exec
  renamable $vgpr25 = V_XOR_B32_e32 killed $vgpr21, $vgpr24, implicit $exec
  ...
  dead renamable $vgpr20 = V_ADD_CO_U32_e32 killed $vgpr20, killed $vgpr38, implicit-def $vcc, implicit $exec
  renamable $vgpr32_vgpr33, dead renamable $sgpr6_sgpr7 = V_MAD_U64_U32_e64 $vgpr25, killed $sgpr8, 0, 0, implicit $exec
  renamable $vgpr30 = V_ADDC_U32_e32 killed $vgpr21, killed $vgpr39, implicit-def $vcc, implicit killed $vcc, implicit $exec
  renamable $vgpr33 = V_ADDC_U32_e32 0, killed $vgpr33, implicit-def dead $vcc, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr31 = V_MUL_LO_U32_e64 $sgpr16, killed $vgpr21, implicit $exec
  renamable $vgpr20_vgpr21, dead renamable $sgpr6_sgpr7 = V_MAD_U64_U32_e64 $sgpr16, killed $vgpr20, 0, 0, implicit $exec
  renamable $vgpr21 = V_ADD3_U32_e64 killed $vgpr21, killed $vgpr31, killed $vgpr30, implicit $exec
  ...
  renamable $vgpr25 = V_CNDMASK_B32_e64 0, 0, 0, -1, killed $vcc, implicit $exec
  V_CMP_LE_U32_e32 killed $sgpr16, $vgpr20, implicit-def $vcc, implicit $exec
  ...
  renamable $vgpr20 = V_CNDMASK_B32_e32 killed $vgpr20, killed $vgpr25, implicit $vcc, implicit $exec
  renamable $vgpr21 = V_CNDMASK_B32_e32 killed $vgpr21, killed $vgpr30, implicit killed $vcc, implicit $exec
...
; predecessors: %bb.26, %bb.61
  ...
  $sgpr6_sgpr7 = S_ANDN2_SAVEEXEC_B64 killed $sgpr10_sgpr11, implicit-def $exec, implicit-def $scc, implicit $exec
...
; predecessors: %bb.27, %bb.28
  ...
  renamable $vgpr19 = V_MUL_LO_U32_e64 killed $vgpr19, $sgpr15, implicit $exec
  ...
  renamable $vgpr143 = V_ADD3_U32_e64 killed $vgpr143, killed $vgpr20, killed $vgpr19, implicit $exec
  ...
  S_CBRANCH_VCCNZ %bb.31, implicit killed $vcc
...
; predecessors: %bb.29, %bb.30
  ...
  renamable $vgpr23 = V_MUL_LO_U32_e64 killed $vgpr23, $sgpr15, implicit $exec
  ...
  renamable $vgpr145 = V_ADD3_U32_e64 killed $vgpr145, killed $vgpr24, killed $vgpr23, implicit $exec
...
; predecessors: %bb.31, %bb.32
  ...
  renamable $vgpr27 = V_MUL_LO_U32_e64 killed $vgpr27, $sgpr15, implicit $exec
  ...
  renamable $vgpr147 = V_ADD3_U32_e64 killed $vgpr147, killed $vgpr30, killed $vgpr27, implicit $exec
  ...
  renamable $vgpr33 = V_MOV_B32_e32 0, implicit $exec
  S_CBRANCH_VCCNZ %bb.35, implicit killed $vcc
...
; predecessors: %bb.33, %bb.34
  ...
  renamable $vgpr27 = V_MUL_LO_U32_e64 killed $vgpr29, $sgpr15, implicit $exec
  ...
  renamable $vgpr149 = V_ADD3_U32_e64 killed $vgpr149, killed $vgpr29, killed $vgpr27, implicit $exec
  $vcc = S_AND_B64 $exec, renamable $sgpr6_sgpr7, implicit-def dead $scc
  renamable $vgpr27 = V_MOV_B32_e32 0, implicit $exec
  renamable $vgpr28 = V_MOV_B32_e32 0, implicit $exec
  renamable $vgpr29 = V_MOV_B32_e32 0, implicit $exec
  S_CBRANCH_VCCNZ %bb.37, implicit killed $vcc
...
; predecessors: %bb.35, %bb.36
  ...
  renamable $vgpr35 = V_MUL_LO_U32_e64 killed $vgpr35, $sgpr15, implicit $exec
  ...
  renamable $vgpr151 = V_ADD3_U32_e64 killed $vgpr151, killed $vgpr38, killed $vgpr35, implicit $exec
...
; predecessors: %bb.37, %bb.38
  ...
  renamable $vgpr35 = V_MUL_LO_U32_e64 killed $vgpr37, $sgpr15, implicit $exec
  ...
  renamable $vgpr153 = V_ADD3_U32_e64 killed $vgpr153, killed $vgpr37, killed $vgpr35, implicit $exec
  $vcc = S_AND_B64 $exec, renamable $sgpr6_sgpr7, implicit-def dead $scc
  renamable $vgpr35 = V_MOV_B32_e32 0, implicit $exec
...
; predecessors: %bb.39, %bb.40
  ...
  renamable $vgpr43 = V_MUL_LO_U32_e64 killed $vgpr43, $sgpr15, implicit $exec
  ...
  renamable $vgpr155 = V_ADD3_U32_e64 killed $vgpr155, killed $vgpr46, killed $vgpr43, implicit $exec
...
; predecessors: %bb.41, %bb.42
  ...
  renamable $vgpr43 = V_MUL_LO_U32_e64 killed $vgpr45, $sgpr15, implicit $exec
  ...
  renamable $vgpr157 = V_ADD3_U32_e64 killed $vgpr157, killed $vgpr45, killed $vgpr43, implicit $exec
  $vcc = S_AND_B64 $exec, renamable $sgpr6_sgpr7, implicit-def dead $scc
  renamable $vgpr43 = V_MOV_B32_e32 0, implicit $exec
...
; predecessors: %bb.43, %bb.44
  ...
  BUNDLE implicit-def $sgpr8_sgpr9_sgpr10_sgpr11, implicit-def $sgpr16_sgpr17, implicit $sgpr0_sgpr1 {
  ...
  BUNDLE implicit killed $vgpr52, implicit killed $vgpr2_vgpr3_vgpr4_vgpr5, implicit $exec, implicit killed $vgpr6_vgpr7_vgpr8_vgpr9, implicit killed $vgpr10_vgpr11_vgpr12_vgpr13, implicit killed $vgpr14_vgpr15_vgpr16_vgpr17 {
  ...
  BUNDLE implicit $vgpr169, implicit killed $vgpr18_vgpr19_vgpr20_vgpr21, implicit $exec, implicit killed $vgpr22_vgpr23_vgpr24_vgpr25, implicit killed $vgpr30_vgpr31_vgpr32_vgpr33, implicit killed $vgpr26_vgpr27_vgpr28_vgpr29, implicit killed $vgpr38_vgpr39_vgpr40_vgpr41, implicit killed $vgpr34_vgpr35_vgpr36_vgpr37, implicit killed $vgpr46_vgpr47_vgpr48_vgpr49, implicit killed $vgpr42_vgpr43_vgpr44_vgpr45 {
  ...
  S_CBRANCH_SCC1 %bb.49, implicit killed $scc
...
; predecessors: %bb.45
  ...
  BUNDLE implicit killed $vgpr190_vgpr191, implicit $exec, implicit $flat_scr, implicit killed $vgpr233, implicit killed $vgpr234_vgpr235, implicit killed $vgpr232, implicit killed $vgpr231, implicit killed $vgpr230 {
    SCRATCH_STORE_DWORDX2_ST killed $vgpr190_vgpr191, 24, 0, implicit $exec, implicit $flat_scr :: (store (s64) into %stack.5, align 4, addrspace 5)
...
; predecessors: %bb.46, %bb.47
  ...
  BUNDLE implicit-def $vgpr130_vgpr131_vgpr132_vgpr133, implicit-def $vgpr134_vgpr135_vgpr136_vgpr137, implicit-def $vgpr138_vgpr139_vgpr140_vgpr141, implicit-def $vgpr142_vgpr143_vgpr144_vgpr145, implicit $vgpr204, implicit $sgpr24_sgpr25_sgpr26_sgpr27, implicit $exec, implicit $vgpr203, implicit $vgpr202, implicit $vgpr201 {
  ...
  BUNDLE implicit-def $vgpr150_vgpr151_vgpr152_vgpr153, implicit-def $vgpr216_vgpr217_vgpr218_vgpr219, implicit-def $vgpr224_vgpr225_vgpr226_vgpr227, implicit-def $vgpr146_vgpr147_vgpr148_vgpr149, implicit-def $vgpr162_vgpr163, implicit-def $vgpr212_vgpr213_vgpr214_vgpr215, implicit-def $vgpr220_vgpr221_vgpr222_vgpr223, implicit $vgpr208, implicit $exec, implicit $vgpr205, implicit $vgpr210, implicit $vgpr164 {
  ...
  BUNDLE implicit-def $vgpr158_vgpr159_vgpr160_vgpr161, implicit-def $vgpr154_vgpr155_vgpr156_vgpr157, implicit $vgpr208, implicit $exec {
  ...
  renamable $vgpr200 = V_PERM_B32_e64 killed $vgpr162, $vgpr162, $sgpr14, implicit $exec
  ...
  BUNDLE implicit-def $vgpr216_vgpr217_vgpr218_vgpr219, implicit-def $vgpr224_vgpr225_vgpr226_vgpr227, implicit-def $vgpr212_vgpr213_vgpr214_vgpr215, implicit-def $vgpr220_vgpr221_vgpr222_vgpr223, implicit $vgpr205, implicit $exec, implicit $vgpr164 {
  ...
  BUNDLE implicit-def $vgpr70_vgpr71_vgpr72_vgpr73, implicit-def $vgpr78_vgpr79_vgpr80_vgpr81, implicit-def $vgpr66_vgpr67_vgpr68_vgpr69, implicit-def $vgpr74_vgpr75_vgpr76_vgpr77, implicit $vgpr205, implicit $exec, implicit $vgpr164 {
  ...
  BUNDLE implicit-def $vgpr38_vgpr39_vgpr40_vgpr41, implicit-def $vgpr46_vgpr47_vgpr48_vgpr49, implicit-def $vgpr34_vgpr35_vgpr36_vgpr37, implicit-def $vgpr42_vgpr43_vgpr44_vgpr45, implicit $vgpr205, implicit $exec, implicit killed $vgpr164 {
  ...
  renamable $vgpr50_vgpr51_vgpr52_vgpr53 = nofpexcept V_MFMA_SCALE_F32_16X16X128_F8F6F4_f4_f8_vgprcd_e64 $vgpr154_vgpr155_vgpr156_vgpr157, $vgpr66_vgpr67_vgpr68_vgpr69_vgpr70_vgpr71_vgpr72_vgpr73, killed $vgpr50_vgpr51_vgpr52_vgpr53, 4, 0, $vgpr1, $vgpr211, 8, 0, implicit $mode, implicit $exec
  ...
  renamable $vgpr244_vgpr245_vgpr246_vgpr247 = nofpexcept V_MFMA_SCALE_F32_16X16X128_F8F6F4_f4_f8_vgprcd_e64 $vgpr154_vgpr155_vgpr156_vgpr157, $vgpr34_vgpr35_vgpr36_vgpr37_vgpr38_vgpr39_vgpr40_vgpr41, killed $vgpr14_vgpr15_vgpr16_vgpr17, 4, 0, $vgpr1, $vgpr211, 8, 0, implicit $mode, implicit $exec
  renamable $vgpr248_vgpr249_vgpr250_vgpr251 = nofpexcept V_MFMA_SCALE_F32_16X16X128_F8F6F4_f4_f8_vgprcd_e64 $vgpr150_vgpr151_vgpr152_vgpr153, $vgpr42_vgpr43_vgpr44_vgpr45_vgpr46_vgpr47_vgpr48_vgpr49, killed $vgpr10_vgpr11_vgpr12_vgpr13, 4, 0, $vgpr200, $vgpr211, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr252_vgpr253_vgpr254_vgpr255 = nofpexcept V_MFMA_SCALE_F32_16X16X128_F8F6F4_f4_f8_vgprcd_e64 $vgpr146_vgpr147_vgpr148_vgpr149, $vgpr42_vgpr43_vgpr44_vgpr45_vgpr46_vgpr47_vgpr48_vgpr49, killed $vgpr6_vgpr7_vgpr8_vgpr9, 4, 0, $vgpr200, $vgpr211, 8, 0, implicit $mode, implicit $exec
  ...
  BUNDLE implicit-def $vgpr158_vgpr159_vgpr160_vgpr161, implicit-def $vgpr6_vgpr7_vgpr8_vgpr9, implicit-def $vgpr2_vgpr3_vgpr4_vgpr5, implicit-def $vgpr10_vgpr11_vgpr12_vgpr13, implicit-def $vgpr14_vgpr15_vgpr16_vgpr17, implicit-def $vgpr192_vgpr193_vgpr194_vgpr195, implicit $vgpr209, implicit $exec, implicit $vgpr207, implicit $vgpr206 {
  ...
  BUNDLE implicit-def $vgpr162_vgpr163_vgpr164_vgpr165, implicit-def $vgpr196_vgpr197_vgpr198_vgpr199, implicit $vgpr209, implicit $exec {
  ...
  renamable $vgpr58_vgpr59_vgpr60_vgpr61 = nofpexcept V_MFMA_SCALE_F32_16X16X128_F8F6F4_f4_f8_vgprcd_e64 $vgpr146_vgpr147_vgpr148_vgpr149, killed $vgpr66_vgpr67_vgpr68_vgpr69_vgpr70_vgpr71_vgpr72_vgpr73, killed $vgpr58_vgpr59_vgpr60_vgpr61, 4, 0, $vgpr200, $vgpr211, 8, 0, implicit $mode, implicit $exec
  ...
  BUNDLE implicit-def $vgpr6_vgpr7_vgpr8_vgpr9, implicit-def $vgpr2_vgpr3_vgpr4_vgpr5, implicit-def $vgpr10_vgpr11_vgpr12_vgpr13, implicit-def $vgpr14_vgpr15_vgpr16_vgpr17, implicit $vgpr207, implicit $exec, implicit $vgpr206 {
  ...
  renamable $vgpr30_vgpr31_vgpr32_vgpr33 = nofpexcept V_MFMA_SCALE_F32_16X16X128_F8F6F4_f4_f8_vgprcd_e64 killed $vgpr150_vgpr151_vgpr152_vgpr153, $vgpr34_vgpr35_vgpr36_vgpr37_vgpr38_vgpr39_vgpr40_vgpr41, killed $vgpr30_vgpr31_vgpr32_vgpr33, 4, 0, $vgpr200, $vgpr211, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr26_vgpr27_vgpr28_vgpr29 = nofpexcept V_MFMA_SCALE_F32_16X16X128_F8F6F4_f4_f8_vgprcd_e64 killed $vgpr146_vgpr147_vgpr148_vgpr149, killed $vgpr34_vgpr35_vgpr36_vgpr37_vgpr38_vgpr39_vgpr40_vgpr41, killed $vgpr26_vgpr27_vgpr28_vgpr29, 4, 0, $vgpr200, $vgpr211, 8, 0, implicit $mode, implicit $exec
  ...
  BUNDLE implicit-def $vgpr6_vgpr7_vgpr8_vgpr9, implicit-def $vgpr2_vgpr3_vgpr4_vgpr5, implicit-def $vgpr146_vgpr147_vgpr148_vgpr149, implicit-def $vgpr150_vgpr151_vgpr152_vgpr153, implicit $vgpr207, implicit $exec, implicit $vgpr206 {
  ...
  renamable $sgpr2 = S_ADD_U32 killed renamable $sgpr2, 128, implicit-def $scc
  renamable $sgpr3 = S_ADDC_U32 killed renamable $sgpr3, 0, implicit-def dead $scc, implicit killed $scc
  ...
  BUNDLE implicit-def $vgpr158_vgpr159_vgpr160_vgpr161, implicit-def $vgpr212_vgpr213_vgpr214_vgpr215, implicit-def $vgpr216_vgpr217_vgpr218_vgpr219, implicit-def $vgpr220_vgpr221_vgpr222_vgpr223, implicit-def $vgpr224_vgpr225_vgpr226_vgpr227, implicit-def $vgpr228_vgpr229_vgpr230_vgpr231, implicit-def $vgpr232_vgpr233_vgpr234_vgpr235, implicit killed $vgpr212_vgpr213, implicit $exec, implicit killed $vgpr214_vgpr215, implicit killed $vgpr2_vgpr3, implicit killed $vgpr4_vgpr5, implicit killed $vgpr6_vgpr7, implicit killed $vgpr8_vgpr9, implicit killed $vgpr232_vgpr233 {
  ...
  S_WAITCNT 49279
  S_BARRIER
  BUNDLE implicit killed $vgpr200, implicit killed $vgpr130_vgpr131_vgpr132_vgpr133, implicit $exec, implicit killed $vgpr134_vgpr135_vgpr136_vgpr137, implicit killed $vgpr138_vgpr139_vgpr140_vgpr141, implicit killed $vgpr142_vgpr143_vgpr144_vgpr145, implicit killed $vgpr236, implicit killed $vgpr238_vgpr239, implicit $vgpr169, implicit killed $vgpr158_vgpr159_vgpr160_vgpr161, implicit killed $vgpr212_vgpr213_vgpr214_vgpr215, implicit killed $vgpr216_vgpr217_vgpr218_vgpr219, implicit killed $vgpr220_vgpr221_vgpr222_vgpr223, implicit killed $vgpr224_vgpr225_vgpr226_vgpr227, implicit killed $vgpr228_vgpr229_vgpr230_vgpr231, implicit killed $vgpr232_vgpr233_vgpr234_vgpr235, implicit killed $vgpr192_vgpr193_vgpr194_vgpr195 {
  ...
  S_CBRANCH_SCC1 %bb.47, implicit killed $scc
...
; predecessors: %bb.47
  ...
  BUNDLE implicit-def $vgpr230, implicit-def $vgpr231, implicit-def $vgpr232, implicit-def $vgpr234_vgpr235, implicit-def $vgpr233, implicit $exec, implicit $flat_scr {
...
; predecessors: %bb.45, %bb.48
  ...
  BUNDLE implicit-def $sgpr14_sgpr15, implicit-def $sgpr0, implicit killed $sgpr0_sgpr1 {
  ...
  $vgpr191 = V_MOV_B32_e32 killed $vgpr235, implicit $exec, implicit $exec
...
; predecessors: %bb.49
  ...
  BUNDLE implicit-def $vgpr180_vgpr181_vgpr182_vgpr183, implicit-def $vgpr204_vgpr205_vgpr206_vgpr207, implicit $vgpr165, implicit $exec, implicit $vgpr162 {
  ...
  renamable $vgpr167 = V_PERM_B32_e64 killed $vgpr146, $vgpr146, $sgpr2, implicit $exec
  ...
  BUNDLE implicit-def $vgpr184_vgpr185_vgpr186_vgpr187, implicit-def $vgpr180_vgpr181_vgpr182_vgpr183, implicit $vgpr164, implicit $exec, implicit $vgpr165 {
  ...
  BUNDLE implicit-def $vgpr204_vgpr205_vgpr206_vgpr207, implicit-def $vgpr200_vgpr201_vgpr202_vgpr203, implicit $vgpr162, implicit $exec, implicit $vgpr188 {
  ...
  BUNDLE implicit-def $vgpr184_vgpr185_vgpr186_vgpr187, implicit-def $vgpr180_vgpr181_vgpr182_vgpr183, implicit killed $vgpr164, implicit $exec, implicit killed $vgpr165 {
  ...
  BUNDLE implicit-def $vgpr204_vgpr205_vgpr206_vgpr207, implicit-def $vgpr200_vgpr201_vgpr202_vgpr203, implicit killed $vgpr162, implicit $exec, implicit killed $vgpr188 {
...
; predecessors: %bb.50, %bb.49
  ...
  $vgpr131 = V_MOV_B32_e32 killed $sgpr19, implicit $exec, implicit $exec
  ...
  renamable $vgpr150 = GLOBAL_LOAD_DWORD_SADDR killed renamable $sgpr8_sgpr9, renamable $vgpr147, 0, 0, implicit $exec :: (load (s32) from %ir.13, addrspace 1)
  ...
  renamable $vgpr146 = V_OR_B32_e32 killed $sgpr12, killed $vgpr192, implicit $exec
  ...
  renamable $sgpr21 = S_AND_B32 killed renamable $sgpr21, 65535, implicit-def dead $scc
  $sgpr22 = S_MOV_B32 killed $sgpr18
  ...
  BUNDLE implicit-def $vgpr142_vgpr143_vgpr144_vgpr145, implicit-def $vgpr134_vgpr135_vgpr136_vgpr137, implicit-def $vgpr130_vgpr131_vgpr132_vgpr133, implicit killed $vgpr132, implicit $exec {
  ...
  renamable $vgpr74 = nofpexcept V_FMA_F32_e64 0, killed $vgpr74, 0, $vgpr150, 0, $vgpr142, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr94 = nofpexcept V_FMA_F32_e64 0, killed $vgpr94, 0, $vgpr150, 0, $vgpr138, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr158 = nofpexcept V_FMA_F32_e64 0, killed $vgpr117, 0, $vgpr150, 0, $vgpr133, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr166 = nofpexcept V_FMA_F32_e64 0, killed $vgpr99, 0, $vgpr150, 0, $vgpr131, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr99 = nofpexcept V_FMA_F32_e64 0, killed $vgpr100, 0, $vgpr150, 0, $vgpr132, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr167 = nofpexcept V_FMA_F32_e64 0, killed $vgpr101, 0, $vgpr150, 0, $vgpr133, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr100 = nofpexcept V_FMA_F32_e64 0, killed $vgpr86, 0, $vgpr150, 0, $vgpr134, 0, 0, implicit $mode, implicit $exec
  ...
  renamable $vgpr133 = nofpexcept V_FMAC_F32_e32 killed $vgpr5, $vgpr150, killed $vgpr133(tied-def 0), implicit $mode, implicit $exec
  renamable $vgpr5 = nofpexcept V_MAX_F32_e64 0, $sgpr15, 0, $sgpr15, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr164 = nofpexcept V_FMA_F32_e64 0, killed $vgpr103, 0, $vgpr150, 0, $vgpr135, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr103 = nofpexcept V_FMA_F32_e64 0, killed $vgpr104, 0, $vgpr150, 0, $vgpr136, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr168 = nofpexcept V_FMA_F32_e64 0, killed $vgpr95, 0, $vgpr150, 0, $vgpr139, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr95 = nofpexcept V_FMA_F32_e64 0, killed $vgpr96, 0, $vgpr150, 0, $vgpr140, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr96 = nofpexcept V_FMA_F32_e64 0, killed $vgpr90, 0, $vgpr150, 0, $vgpr142, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr104 = nofpexcept V_FMA_F32_e64 0, killed $vgpr82, 0, $vgpr150, 0, $vgpr130, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr66 = nofpexcept V_FMA_F32_e64 0, killed $vgpr66, 0, $vgpr150, 0, $vgpr130, 0, 0, implicit $mode, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_FMA_F32_e64 0, killed $vgpr122, 0, $vgpr150, 0, $vgpr138, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr169 = nofpexcept V_FMA_F32_e64 0, killed $vgpr97, 0, $vgpr150, 0, $vgpr141, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr97 = nofpexcept V_FMA_F32_e64 0, killed $vgpr92, 0, $vgpr150, 0, $vgpr144, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr178 = nofpexcept V_FMA_F32_e64 0, killed $vgpr81, 0, $vgpr150, 0, $vgpr141, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr75 = nofpexcept V_FMA_F32_e64 0, killed $vgpr75, 0, $vgpr150, 0, $vgpr143, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr50 = nofpexcept V_FMA_F32_e64 0, killed $vgpr50, 0, $vgpr150, 0, $vgpr130, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr52 = nofpexcept V_FMA_F32_e64 0, killed $vgpr52, 0, $vgpr150, 0, $vgpr132, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr35 = nofpexcept V_FMA_F32_e64 0, killed $vgpr35, 0, $vgpr150, 0, $vgpr131, 0, 0, implicit $mode, implicit $exec
  ...
  renamable $vgpr159 = nofpexcept V_FMA_F32_e64 0, killed $vgpr111, 0, $vgpr150, 0, $vgpr139, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr111 = nofpexcept V_FMA_F32_e64 0, killed $vgpr112, 0, $vgpr150, 0, $vgpr140, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr160 = nofpexcept V_FMA_F32_e64 0, killed $vgpr113, 0, $vgpr150, 0, $vgpr141, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr80 = nofpexcept V_FMA_F32_e64 0, killed $vgpr80, 0, $vgpr150, 0, $vgpr140, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr58 = nofpexcept V_FMA_F32_e64 0, killed $vgpr58, 0, $vgpr150, 0, $vgpr142, 0, 0, implicit $mode, implicit $exec
  ...
  renamable $vgpr118 = nofpexcept V_FMA_F32_e64 0, killed $vgpr118, 0, $vgpr150, 0, $vgpr134, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr161 = nofpexcept V_FMA_F32_e64 0, killed $vgpr107, 0, $vgpr150, 0, $vgpr143, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr107 = nofpexcept V_FMA_F32_e64 0, killed $vgpr108, 0, $vgpr150, 0, $vgpr144, 0, 0, implicit $mode, implicit $exec
  ...
  renamable $vgpr38 = nofpexcept V_FMA_F32_e64 0, killed $vgpr38, 0, $vgpr150, 0, $vgpr134, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr22 = nofpexcept V_FMA_F32_e64 0, killed $vgpr22, 0, $vgpr150, 0, $vgpr134, 0, 0, implicit $mode, implicit $exec
  ...
  renamable $vgpr151 = nofpexcept V_FMA_F32_e64 0, killed $vgpr123, 0, $vgpr150, 0, $vgpr139, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr123 = nofpexcept V_FMA_F32_e64 0, killed $vgpr126, 0, $vgpr150, 0, $vgpr142, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr153 = nofpexcept V_FMA_F32_e64 0, killed $vgpr127, 0, $vgpr150, 0, $vgpr143, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr102 = nofpexcept V_FMA_F32_e64 0, killed $vgpr102, 0, $vgpr150, 0, $vgpr134, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr70 = nofpexcept V_FMA_F32_e64 0, killed $vgpr70, 0, $vgpr150, 0, $vgpr134, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr42 = nofpexcept V_FMA_F32_e64 0, killed $vgpr42, 0, $vgpr150, 0, $vgpr142, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr8 = nofpexcept V_FMA_F32_e64 0, killed $vgpr8, 0, $vgpr150, 0, $vgpr144, 0, 0, implicit $mode, implicit $exec
  ...
  renamable $vgpr157 = nofpexcept V_FMA_F32_e64 0, killed $vgpr115, 0, $vgpr150, 0, $vgpr131, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr115 = nofpexcept V_FMA_F32_e64 0, killed $vgpr116, 0, $vgpr150, 0, $vgpr132, 0, 0, implicit $mode, implicit $exec
  ...
  renamable $vgpr110 = nofpexcept V_FMA_F32_e64 0, killed $vgpr110, 0, $vgpr150, 0, $vgpr138, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr54 = nofpexcept V_FMA_F32_e64 0, killed $vgpr54, 0, $vgpr150, 0, $vgpr134, 0, 0, implicit $mode, implicit $exec
  ...
  renamable $vgpr122 = nofpexcept V_FMA_F32_e64 0, killed $vgpr124, 0, $vgpr150, 0, $vgpr140, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr152 = nofpexcept V_FMA_F32_e64 0, killed $vgpr125, 0, $vgpr150, 0, $vgpr141, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr124 = nofpexcept V_FMA_F32_e64 0, killed $vgpr128, 0, $vgpr150, 0, $vgpr144, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr154 = nofpexcept V_FMA_F32_e64 0, killed $vgpr129, 0, $vgpr150, 0, $vgpr145, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr155 = nofpexcept V_FMA_F32_e64 0, killed $vgpr119, 0, $vgpr150, 0, $vgpr135, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr119 = nofpexcept V_FMA_F32_e64 0, killed $vgpr120, 0, $vgpr150, 0, $vgpr136, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr156 = nofpexcept V_FMA_F32_e64 0, killed $vgpr121, 0, $vgpr150, 0, $vgpr137, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr114 = nofpexcept V_FMA_F32_e64 0, killed $vgpr114, 0, $vgpr150, 0, $vgpr130, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr106 = nofpexcept V_FMA_F32_e64 0, killed $vgpr106, 0, $vgpr150, 0, $vgpr142, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr165 = nofpexcept V_FMA_F32_e64 0, killed $vgpr105, 0, $vgpr150, 0, $vgpr137, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr98 = nofpexcept V_FMA_F32_e64 0, killed $vgpr98, 0, $vgpr150, 0, $vgpr130, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr170 = nofpexcept V_FMA_F32_e64 0, killed $vgpr91, 0, $vgpr150, 0, $vgpr143, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr171 = nofpexcept V_FMA_F32_e64 0, killed $vgpr93, 0, $vgpr150, 0, $vgpr145, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr172 = nofpexcept V_FMA_F32_e64 0, killed $vgpr87, 0, $vgpr150, 0, $vgpr135, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr101 = nofpexcept V_FMA_F32_e64 0, killed $vgpr88, 0, $vgpr150, 0, $vgpr136, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr174 = nofpexcept V_FMA_F32_e64 0, killed $vgpr83, 0, $vgpr150, 0, $vgpr131, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr105 = nofpexcept V_FMA_F32_e64 0, killed $vgpr84, 0, $vgpr150, 0, $vgpr132, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr78 = nofpexcept V_FMA_F32_e64 0, killed $vgpr78, 0, $vgpr150, 0, $vgpr138, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr79 = nofpexcept V_FMA_F32_e64 0, killed $vgpr79, 0, $vgpr150, 0, $vgpr139, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr76 = nofpexcept V_FMA_F32_e64 0, killed $vgpr76, 0, $vgpr150, 0, $vgpr144, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr77 = nofpexcept V_FMA_F32_e64 0, killed $vgpr77, 0, $vgpr150, 0, $vgpr145, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr179 = nofpexcept V_FMA_F32_e64 0, killed $vgpr71, 0, $vgpr150, 0, $vgpr135, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr71 = nofpexcept V_FMA_F32_e64 0, killed $vgpr72, 0, $vgpr150, 0, $vgpr136, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr180 = nofpexcept V_FMA_F32_e64 0, killed $vgpr73, 0, $vgpr150, 0, $vgpr137, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr67 = nofpexcept V_FMA_F32_e64 0, killed $vgpr67, 0, $vgpr150, 0, $vgpr131, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr68 = nofpexcept V_FMA_F32_e64 0, killed $vgpr68, 0, $vgpr150, 0, $vgpr132, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr62 = nofpexcept V_FMA_F32_e64 0, killed $vgpr62, 0, $vgpr150, 0, $vgpr138, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr63 = nofpexcept V_FMA_F32_e64 0, killed $vgpr63, 0, $vgpr150, 0, $vgpr139, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr64 = nofpexcept V_FMA_F32_e64 0, killed $vgpr64, 0, $vgpr150, 0, $vgpr140, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr65 = nofpexcept V_FMA_F32_e64 0, killed $vgpr65, 0, $vgpr150, 0, $vgpr141, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr59 = nofpexcept V_FMA_F32_e64 0, killed $vgpr59, 0, $vgpr150, 0, $vgpr143, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr60 = nofpexcept V_FMA_F32_e64 0, killed $vgpr60, 0, $vgpr150, 0, $vgpr144, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr61 = nofpexcept V_FMA_F32_e64 0, killed $vgpr61, 0, $vgpr150, 0, $vgpr145, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr55 = nofpexcept V_FMA_F32_e64 0, killed $vgpr55, 0, $vgpr150, 0, $vgpr135, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr56 = nofpexcept V_FMA_F32_e64 0, killed $vgpr56, 0, $vgpr150, 0, $vgpr136, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr57 = nofpexcept V_FMA_F32_e64 0, killed $vgpr57, 0, $vgpr150, 0, $vgpr137, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr51 = nofpexcept V_FMA_F32_e64 0, killed $vgpr51, 0, $vgpr150, 0, $vgpr131, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr46 = nofpexcept V_FMA_F32_e64 0, killed $vgpr46, 0, $vgpr150, 0, $vgpr138, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr47 = nofpexcept V_FMA_F32_e64 0, killed $vgpr47, 0, $vgpr150, 0, $vgpr139, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr48 = nofpexcept V_FMA_F32_e64 0, killed $vgpr48, 0, $vgpr150, 0, $vgpr140, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr43 = nofpexcept V_FMA_F32_e64 0, killed $vgpr43, 0, $vgpr150, 0, $vgpr143, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr44 = nofpexcept V_FMA_F32_e64 0, killed $vgpr44, 0, $vgpr150, 0, $vgpr144, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr39 = nofpexcept V_FMA_F32_e64 0, killed $vgpr39, 0, $vgpr150, 0, $vgpr135, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr40 = nofpexcept V_FMA_F32_e64 0, killed $vgpr40, 0, $vgpr150, 0, $vgpr136, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr34 = nofpexcept V_FMA_F32_e64 0, killed $vgpr34, 0, $vgpr150, 0, $vgpr130, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr36 = nofpexcept V_FMA_F32_e64 0, killed $vgpr36, 0, $vgpr150, 0, $vgpr132, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr30 = nofpexcept V_FMA_F32_e64 0, killed $vgpr30, 0, $vgpr150, 0, $vgpr138, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr31 = nofpexcept V_FMA_F32_e64 0, killed $vgpr31, 0, $vgpr150, 0, $vgpr139, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr32 = nofpexcept V_FMA_F32_e64 0, killed $vgpr32, 0, $vgpr150, 0, $vgpr140, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr33 = nofpexcept V_FMA_F32_e64 0, killed $vgpr33, 0, $vgpr150, 0, $vgpr141, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr26 = nofpexcept V_FMA_F32_e64 0, killed $vgpr26, 0, $vgpr150, 0, $vgpr142, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr27 = nofpexcept V_FMA_F32_e64 0, killed $vgpr27, 0, $vgpr150, 0, $vgpr143, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr28 = nofpexcept V_FMA_F32_e64 0, killed $vgpr28, 0, $vgpr150, 0, killed $vgpr144, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr23 = nofpexcept V_FMA_F32_e64 0, killed $vgpr23, 0, $vgpr150, 0, $vgpr135, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr24 = nofpexcept V_FMA_F32_e64 0, killed $vgpr24, 0, $vgpr150, 0, $vgpr136, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr25 = nofpexcept V_FMA_F32_e64 0, killed $vgpr25, 0, $vgpr150, 0, $vgpr137, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr14 = nofpexcept V_FMA_F32_e64 0, killed $vgpr14, 0, $vgpr150, 0, $vgpr130, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr15 = nofpexcept V_FMA_F32_e64 0, killed $vgpr15, 0, $vgpr150, 0, $vgpr131, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr16 = nofpexcept V_FMA_F32_e64 0, killed $vgpr16, 0, $vgpr150, 0, $vgpr132, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr10 = nofpexcept V_FMA_F32_e64 0, killed $vgpr10, 0, $vgpr150, 0, killed $vgpr138, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr11 = nofpexcept V_FMA_F32_e64 0, killed $vgpr11, 0, $vgpr150, 0, killed $vgpr139, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr12 = nofpexcept V_FMA_F32_e64 0, killed $vgpr12, 0, $vgpr150, 0, killed $vgpr140, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr141 = nofpexcept V_FMAC_F32_e32 killed $vgpr13, $vgpr150, killed $vgpr141(tied-def 0), implicit $mode, implicit $exec
  renamable $vgpr6 = nofpexcept V_FMA_F32_e64 0, killed $vgpr6, 0, $vgpr150, 0, killed $vgpr142, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr7 = nofpexcept V_FMA_F32_e64 0, killed $vgpr7, 0, $vgpr150, 0, killed $vgpr143, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr145 = nofpexcept V_FMAC_F32_e32 killed $vgpr9, $vgpr150, killed $vgpr145(tied-def 0), implicit $mode, implicit $exec
  renamable $vgpr9 = nofpexcept V_FMA_F32_e64 0, killed $vgpr18, 0, $vgpr150, 0, killed $vgpr134, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr13 = nofpexcept V_FMA_F32_e64 0, killed $vgpr19, 0, $vgpr150, 0, killed $vgpr135, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr18 = nofpexcept V_FMA_F32_e64 0, killed $vgpr20, 0, $vgpr150, 0, killed $vgpr136, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr137 = nofpexcept V_FMAC_F32_e32 killed $vgpr21, $vgpr150, killed $vgpr137(tied-def 0), implicit $mode, implicit $exec
  renamable $vgpr2 = nofpexcept V_FMA_F32_e64 0, killed $vgpr2, 0, $vgpr150, 0, killed $vgpr130, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr19 = nofpexcept V_FMA_F32_e64 0, killed $vgpr3, 0, $vgpr150, 0, killed $vgpr131, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr4 = nofpexcept V_FMA_F32_e64 0, killed $vgpr4, 0, killed $vgpr150, 0, killed $vgpr132, 0, 0, implicit $mode, implicit $exec
  ...
  renamable $vgpr67 = nofpexcept V_MAX_F32_e64 1, killed $sgpr15, 0, killed $vgpr133, 0, 0, implicit $mode, implicit $exec
  ...
  renamable $vgpr74 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr74, 0, killed $vgpr173, 0, killed $vgpr174, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr173 = nofpexcept V_RCP_F32_e32 $vgpr162, implicit $mode, implicit $exec
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr175, 0, killed $vgpr75, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr173, 0, killed $vgpr76, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr173 = nofpexcept V_RCP_F32_e32 $vgpr162, implicit $mode, implicit $exec
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr174, 0, killed $vgpr77, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr174 = nofpexcept V_RCP_F32_e32 $vgpr162, implicit $mode, implicit $exec
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr173, 0, killed $vgpr78, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr173 = nofpexcept V_RCP_F32_e32 $vgpr162, implicit $mode, implicit $exec
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr174, 0, killed $vgpr79, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr174 = nofpexcept V_RCP_F32_e32 $vgpr162, implicit $mode, implicit $exec
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr173, 0, killed $vgpr80, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr175 = nofpexcept V_RCP_F32_e32 $vgpr162, implicit $mode, implicit $exec
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr174, 0, killed $vgpr173, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr174 = nofpexcept V_RCP_F32_e32 $vgpr162, implicit $mode, implicit $exec
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr175, 0, killed $vgpr173, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr173 = nofpexcept V_RCP_F32_e32 $vgpr162, implicit $mode, implicit $exec
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr175, 0, killed $vgpr172, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr173, 0, killed $vgpr171, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr172, 0, killed $vgpr170, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr171, 0, killed $vgpr169, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr170, 0, killed $vgpr168, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr169, 0, killed $vgpr167, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr168, 0, killed $vgpr166, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr167, 0, killed $vgpr165, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr166, 0, killed $vgpr164, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr165, 0, killed $vgpr161, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr164, 0, killed $vgpr160, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr162, 0, killed $vgpr159, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr161, 0, killed $vgpr158, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr160, 0, killed $vgpr157, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr159, 0, killed $vgpr156, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr158, 0, killed $vgpr155, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr157, 0, killed $vgpr154, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr156, 0, killed $vgpr153, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr155, 0, killed $vgpr152, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr154, 0, killed $vgpr151, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr153, 0, killed $vgpr150, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr152, 0, killed $vgpr145, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr151, 0, killed $vgpr144, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr150, 0, killed $vgpr143, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr145, 0, killed $vgpr142, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr144, 0, killed $vgpr141, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr143, 0, killed $vgpr140, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr142, 0, killed $vgpr139, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr141, 0, killed $vgpr138, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr140, 0, killed $vgpr137, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr139, 0, killed $vgpr136, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr138, 0, killed $vgpr135, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr137, 0, killed $vgpr134, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr136, 0, killed $vgpr133, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr135, 0, killed $vgpr133, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr136, 0, killed $vgpr3, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr4, 0, killed $vgpr6, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr7, 0, killed $vgpr6, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr9, 0, killed $vgpr6, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr8, 0, killed $vgpr9, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr11, 0, killed $vgpr8, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  renamable $vgpr8 = nofpexcept V_DIV_FIXUP_F32_e64 0, killed $vgpr1, 0, $vgpr132, 0, killed $vgpr78, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr4 = V_CVT_SCALEF32_PK_FP8_F32_e64 8, killed $vgpr6, 0, killed $vgpr7, 0, 1065353216, killed $vgpr4(tied-def 0), 0, implicit $mode, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr10, 0, killed $vgpr11, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr13, 0, killed $vgpr10, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr12, 0, killed $vgpr13, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr15, 0, killed $vgpr12, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  renamable $vgpr12 = nofpexcept V_DIV_FIXUP_F32_e64 0, killed $vgpr1, 0, $vgpr132, 0, killed $vgpr82, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr8 = V_CVT_SCALEF32_PK_FP8_F32_e64 8, killed $vgpr10, 0, killed $vgpr11, 0, 1065353216, killed $vgpr8(tied-def 0), 0, implicit $mode, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr14, 0, killed $vgpr15, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr17, 0, killed $vgpr14, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr16, 0, killed $vgpr17, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr19, 0, killed $vgpr16, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  renamable $vgpr16 = nofpexcept V_DIV_FIXUP_F32_e64 0, killed $vgpr1, 0, $vgpr132, 0, killed $vgpr86, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr12 = V_CVT_SCALEF32_PK_FP8_F32_e64 8, killed $vgpr14, 0, killed $vgpr15, 0, 1065353216, killed $vgpr12(tied-def 0), 0, implicit $mode, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr18, 0, killed $vgpr19, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr21, 0, killed $vgpr18, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr20, 0, killed $vgpr21, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr23, 0, killed $vgpr20, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  renamable $vgpr20 = nofpexcept V_DIV_FIXUP_F32_e64 0, killed $vgpr1, 0, $vgpr132, 0, killed $vgpr90, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr16 = V_CVT_SCALEF32_PK_FP8_F32_e64 8, killed $vgpr18, 0, killed $vgpr19, 0, 1065353216, killed $vgpr16(tied-def 0), 0, implicit $mode, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr22, 0, killed $vgpr23, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr25, 0, killed $vgpr22, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr24, 0, killed $vgpr25, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr27, 0, killed $vgpr24, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr26, 0, killed $vgpr27, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr29, 0, killed $vgpr26, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  renamable $vgpr26 = nofpexcept V_DIV_FIXUP_F32_e64 0, killed $vgpr1, 0, $vgpr132, 0, killed $vgpr96, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr5 = V_CVT_SCALEF32_PK_FP8_F32_e64 8, killed $vgpr22, 0, killed $vgpr23, 0, 1065353216, killed $vgpr5(tied-def 0), 0, implicit $mode, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr28, 0, killed $vgpr29, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr31, 0, killed $vgpr28, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr30, 0, killed $vgpr31, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr33, 0, killed $vgpr30, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr32, 0, killed $vgpr33, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr35, 0, killed $vgpr32, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr34, 0, killed $vgpr35, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr37, 0, killed $vgpr34, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr36, 0, killed $vgpr37, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr39, 0, killed $vgpr36, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr38, 0, killed $vgpr39, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr41, 0, killed $vgpr38, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr1 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr1, 0, killed $vgpr40, 0, killed $vgpr41, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  renamable $vgpr1 = nofpexcept V_DIV_FIXUP_F32_e64 0, killed $vgpr1, 0, $vgpr132, 0, killed $vgpr109, 0, 0, implicit $mode, implicit $exec
  renamable $vgpr6 = V_CVT_SCALEF32_PK_FP8_F32_e64 8, killed $vgpr38, 0, killed $vgpr1, 0, 1065353216, killed $vgpr6(tied-def 0), 0, implicit $mode, implicit $exec
  ...
  renamable $vgpr39 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr39, 0, killed $vgpr42, 0, killed $vgpr41, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr40 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr40, 0, killed $vgpr43, 0, killed $vgpr42, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr41 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr41, 0, killed $vgpr44, 0, killed $vgpr43, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr42 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr42, 0, killed $vgpr45, 0, killed $vgpr44, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr43 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr43, 0, killed $vgpr46, 0, killed $vgpr45, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr44 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr44, 0, killed $vgpr47, 0, killed $vgpr46, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr9 = V_CVT_SCALEF32_PK_FP8_F32_e64 8, killed $vgpr26, 0, killed $vgpr27, 0, 1065353216, killed $vgpr9(tied-def 0), 0, implicit $mode, implicit $exec
  ...
  renamable $vgpr45 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr45, 0, killed $vgpr48, 0, killed $vgpr47, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr46 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr46, 0, killed $vgpr49, 0, killed $vgpr48, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr47 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr47, 0, killed $vgpr50, 0, killed $vgpr49, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr10 = V_CVT_SCALEF32_PK_FP8_F32_e64 8, killed $vgpr41, 0, killed $vgpr42, 0, 1065353216, killed $vgpr10(tied-def 0), 0, implicit $mode, implicit $exec
  ...
  renamable $vgpr48 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr48, 0, killed $vgpr51, 0, killed $vgpr50, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr49 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr49, 0, killed $vgpr52, 0, killed $vgpr51, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr50 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr50, 0, killed $vgpr53, 0, killed $vgpr52, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr51 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr51, 0, killed $vgpr54, 0, killed $vgpr53, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr52 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr52, 0, killed $vgpr55, 0, killed $vgpr54, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr53 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr53, 0, killed $vgpr56, 0, killed $vgpr55, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr54 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr54, 0, killed $vgpr57, 0, killed $vgpr56, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr7 = V_CVT_SCALEF32_PK_FP8_F32_e64 8, killed $vgpr53, 0, killed $vgpr54, 0, 1065353216, killed $vgpr7(tied-def 0), 0, implicit $mode, implicit $exec
  ...
  renamable $vgpr55 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr55, 0, killed $vgpr58, 0, killed $vgpr57, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr13 = V_CVT_SCALEF32_PK_FP8_F32_e64 8, killed $vgpr30, 0, killed $vgpr31, 0, 1065353216, killed $vgpr13(tied-def 0), 0, implicit $mode, implicit $exec
  ...
  renamable $vgpr56 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr56, 0, killed $vgpr59, 0, killed $vgpr58, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr57 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr57, 0, killed $vgpr60, 0, killed $vgpr59, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr17 = V_CVT_SCALEF32_PK_FP8_F32_e64 8, killed $vgpr34, 0, killed $vgpr35, 0, 1065353216, killed $vgpr17(tied-def 0), 0, implicit $mode, implicit $exec
  ...
  renamable $vgpr58 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr58, 0, killed $vgpr61, 0, killed $vgpr60, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr11 = V_CVT_SCALEF32_PK_FP8_F32_e64 8, killed $vgpr57, 0, killed $vgpr58, 0, 1065353216, killed $vgpr11(tied-def 0), 0, implicit $mode, implicit $exec
  ...
  renamable $vgpr59 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr59, 0, killed $vgpr62, 0, killed $vgpr61, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr14 = V_CVT_SCALEF32_PK_FP8_F32_e64 8, killed $vgpr45, 0, killed $vgpr46, 0, 1065353216, killed $vgpr14(tied-def 0), 0, implicit $mode, implicit $exec
  ...
  renamable $vgpr60 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr60, 0, killed $vgpr63, 0, killed $vgpr62, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr61 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr61, 0, killed $vgpr64, 0, killed $vgpr63, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr18 = V_CVT_SCALEF32_PK_FP8_F32_e64 8, killed $vgpr49, 0, killed $vgpr50, 0, 1065353216, killed $vgpr18(tied-def 0), 0, implicit $mode, implicit $exec
  ...
  renamable $vgpr62 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr62, 0, killed $vgpr65, 0, killed $vgpr64, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr15 = V_CVT_SCALEF32_PK_FP8_F32_e64 8, killed $vgpr61, 0, killed $vgpr62, 0, 1065353216, killed $vgpr15(tied-def 0), 0, implicit $mode, implicit $exec
  ...
  renamable $vgpr63 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr63, 0, killed $vgpr66, 0, killed $vgpr65, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  BUNDLE implicit killed $vgpr20, implicit killed $vgpr4_vgpr5_vgpr6_vgpr7, implicit $exec, implicit killed $vgpr12_vgpr13_vgpr14_vgpr15 {
  ...
  renamable $vgpr64 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr64, 0, killed $vgpr67, 0, killed $vgpr66, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr65 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr65, 0, killed $vgpr69, 0, killed $vgpr67, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr66 = nofpexcept V_DIV_FMAS_F32_e64 0, killed $vgpr66, 0, killed $vgpr68, 0, killed $vgpr69, 0, 0, implicit $mode, implicit killed $vcc, implicit $exec
  ...
  renamable $vgpr19 = V_CVT_SCALEF32_PK_FP8_F32_e64 8, killed $vgpr65, 0, killed $vgpr66, 0, 1065353216, killed $vgpr19(tied-def 0), 0, implicit $mode, implicit $exec
  BUNDLE implicit killed $vgpr1, implicit killed $vgpr8_vgpr9_vgpr10_vgpr11, implicit $exec, implicit killed $vgpr16_vgpr17_vgpr18_vgpr19 {
  ...
  S_BARRIER
  ATOMIC_FENCE 4, 2
  BUNDLE implicit-def $vgpr4_vgpr5_vgpr6_vgpr7, implicit-def $vgpr8_vgpr9_vgpr10_vgpr11, implicit $vgpr1, implicit $exec {
  ...
  $vgpr3 = V_MOV_B32_e32 killed $sgpr13, implicit $exec, implicit $exec
  ...
  renamable $vgpr12 = V_PERM_B32_e64 killed $vgpr4, killed $vgpr8, $sgpr12, implicit $exec
  renamable $vgpr14 = V_PERM_B32_e64 $vgpr5, $vgpr9, $sgpr13, implicit $exec
  renamable $vgpr16 = V_PERM_B32_e64 killed $vgpr5, killed $vgpr9, $sgpr12, implicit $exec
  renamable $vgpr18 = V_PERM_B32_e64 $vgpr6, $vgpr10, $sgpr13, implicit $exec
  renamable $vgpr20 = V_PERM_B32_e64 killed $vgpr6, killed $vgpr10, $sgpr12, implicit $exec
  ...
  BUNDLE implicit-def $vgpr4_vgpr5_vgpr6_vgpr7, implicit-def $vgpr8_vgpr9_vgpr10_vgpr11, implicit killed $vgpr1, implicit $exec {
  ...
  renamable $vgpr25 = V_ADD_U32_e32 $vgpr2, $vgpr15, implicit $exec
  renamable $vgpr26 = V_ADD_U32_e32 $vgpr146, $vgpr1, implicit $exec
  ...
  renamable $vgpr13 = V_PERM_B32_e64 killed $vgpr4, killed $vgpr8, $sgpr12, implicit $exec
  ...
  renamable $vgpr23 = V_ADD_U32_e32 killed $vgpr146, killed $vgpr15, implicit $exec
  ...
  renamable $vgpr17 = V_PERM_B32_e64 killed $vgpr5, killed $vgpr9, $sgpr12, implicit $exec
  ...
  renamable $vgpr21 = V_PERM_B32_e64 killed $vgpr6, killed $vgpr10, $sgpr12, implicit $exec
