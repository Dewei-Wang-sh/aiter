...
; predecessors: %bb.62, %bb.63
  successors: %bb.1(0x40000000), %bb.61(0x40000000); %bb.1(50.00%), %bb.61(50.00%)
...
bb.1 (%ir-block.39):
; predecessors: %bb.0
  successors: %bb.2(0x50000000), %bb.61(0x30000000); %bb.2(62.50%), %bb.61(37.50%)
  ...
  S_CBRANCH_VCCNZ %bb.61, implicit killed $vcc
...
; predecessors: %bb.24, %bb.25
  ...
  $sgpr8_sgpr9 = S_AND_SAVEEXEC_B64 killed $sgpr6_sgpr7, implicit-def $exec, implicit-def $scc, implicit $exec
  renamable $sgpr16_sgpr17 = S_XOR_B64 $exec, killed renamable $sgpr8_sgpr9, implicit-def dead $scc
  S_CBRANCH_EXECZ %bb.28, implicit $exec
...
; predecessors: %bb.28, %bb.29
  ...
  $sgpr8_sgpr9 = S_AND_SAVEEXEC_B64 killed $sgpr6_sgpr7, implicit-def $exec, implicit-def $scc, implicit $exec
  renamable $sgpr16_sgpr17 = S_XOR_B64 $exec, killed renamable $sgpr8_sgpr9, implicit-def dead $scc
  S_CBRANCH_EXECZ %bb.32, implicit $exec
...
; predecessors: %bb.36, %bb.37
  ...
  S_CBRANCH_VCCNZ %bb.40, implicit killed $vcc
...
; predecessors: %bb.40, %bb.41
  ...
  renamable $vgpr33 = V_MOV_B32_e32 0, implicit $exec
  S_CBRANCH_VCCNZ %bb.44, implicit killed $vcc
...
; predecessors: %bb.42, %bb.43
  ...
  renamable $vgpr29 = V_MOV_B32_e32 0, implicit $exec
  S_CBRANCH_VCCNZ %bb.46, implicit killed $vcc
...
; predecessors: %bb.44, %bb.45
  ...
  S_CBRANCH_VCCNZ %bb.48, implicit killed $vcc
...
; predecessors: %bb.46, %bb.47
  ...
  renamable $vgpr37 = V_MOV_B32_e32 0, implicit $exec
  S_CBRANCH_VCCNZ %bb.50, implicit killed $vcc
...
; predecessors: %bb.50, %bb.51
  ...
  renamable $vgpr45 = V_MOV_B32_e32 0, implicit $exec
  S_CBRANCH_VCCNZ %bb.54, implicit killed $vcc
...
; predecessors: %bb.52, %bb.53
  successors: %bb.55(0x40000000), %bb.58(0x40000000); %bb.55(50.00%), %bb.58(50.00%)
...
; predecessors: %bb.55, %bb.56
  successors: %bb.57(0x04000000), %bb.56(0x7c000000); %bb.57(3.12%), %bb.56(96.88%)
...
bb.58.Flow340:
; predecessors: %bb.54, %bb.57
  successors: %bb.59(0x40000000), %bb.60(0x40000000); %bb.59(50.00%), %bb.60(50.00%)
  ...
  S_WAITCNT 49279
  S_BARRIER
  S_CBRANCH_VCCNZ %bb.60, implicit killed $vcc
