# *** IR Dump After AMDGPU Rewrite AGPR-Copy-MFMA (amdgpu-rewrite-agpr-copy-mfma) ***:
...
3120B	  %9438:vgpr_32 = V_LSHRREV_B32_e32 4, %999:vgpr_32(s32), implicit $exec
...
4384B	  %9441:vgpr_32 = disjoint V_OR_B32_e32 32, %9438:vgpr_32, implicit $exec
4400B	  %9443:vgpr_32 = disjoint V_OR_B32_e32 64, %9438:vgpr_32, implicit $exec
4416B	  %9445:vgpr_32 = disjoint V_OR_B32_e32 96, %9438:vgpr_32, implicit $exec
...
4464B	  %9447:vreg_64_align2 = nsw V_LSHLREV_B64_e64 7, %8462:vreg_64_align2, implicit $exec
...
4512B	  undef %8422.sub0:vreg_64_align2 = V_OR_B32_e32 %9447.sub0:vreg_64_align2, %9438:vgpr_32, implicit $exec
4528B	  undef %8420.sub0:vreg_64_align2 = V_OR_B32_e32 %9447.sub0:vreg_64_align2, %9441:vgpr_32, implicit $exec
4544B	  undef %8418.sub0:vreg_64_align2 = V_OR_B32_e32 %9447.sub0:vreg_64_align2, %9443:vgpr_32, implicit $exec
4560B	  undef %9457.sub0:vreg_64_align2 = V_OR_B32_e32 %9447.sub0:vreg_64_align2, %9445:vgpr_32, implicit $exec
4576B	  %9449:vgpr_32 = GLOBAL_LOAD_DWORD_SADDR killed renamable $sgpr2_sgpr3, %8459:vgpr_32, 0, 0, implicit $exec :: (load (s32) from %ir.195, addrspace 1)
...
4720B	  %1295:vgpr_32 = V_ASHRREV_I32_e32 31, %9457.sub0:vreg_64_align2, implicit $exec
4736B	  %1296:vgpr_32 = V_SUB_U32_e32 0, %9457.sub0:vreg_64_align2, implicit $exec
...
4816B	  %1297:vgpr_32 = V_MAX_I32_e32 %9457.sub0:vreg_64_align2, %1296:vgpr_32, implicit $exec
...
5888B	  %1315:vgpr_32 = V_ADD_LSHL_U32_e64 %9449:vgpr_32, %1266:vgpr_32, 2, implicit $exec
5920B	  %1317:vgpr_32 = V_ADD_LSHL_U32_e64 %9449:vgpr_32, %1280:vgpr_32, 2, implicit $exec
5952B	  %1319:vgpr_32 = V_ADD_LSHL_U32_e64 %9449:vgpr_32, %1294:vgpr_32, 2, implicit $exec
5984B	  %1321:vgpr_32 = V_ADD_LSHL_U32_e64 %9449:vgpr_32, %1308:vgpr_32, 2, implicit $exec
...
6416B	  %9464:vgpr_32 = V_AND_B32_e32 15, %999:vgpr_32(s32), implicit $exec
6656B	  %1367:vgpr_32 = V_MOV_B32_e32 -2147483648, implicit $exec
6672B	  undef %9461.sub0:vreg_64_align2 = V_LSHLREV_B32_e32 4, %9464:vgpr_32, implicit $exec
...
7024B	  %1345:vreg_64_align2, dead renamable $sgpr2_sgpr3 = V_MAD_U64_U32_e64 %1328:vgpr_32, $sgpr8, %9461:vreg_64_align2, 0, implicit $exec
7040B	  %1348:vreg_64_align2, dead renamable $sgpr2_sgpr3 = V_MAD_U64_U32_e64 %1332:vgpr_32, $sgpr8, %9461:vreg_64_align2, 0, implicit $exec
7056B	  %1351:vreg_64_align2, dead renamable $sgpr2_sgpr3 = V_MAD_U64_U32_e64 %1336:vgpr_32, $sgpr8, %9461:vreg_64_align2, 0, implicit $exec
7072B	  %1354:vreg_64_align2, dead renamable $sgpr2_sgpr3 = V_MAD_U64_U32_e64 %1340:vgpr_32, killed $sgpr8, %9461:vreg_64_align2, 0, implicit $exec
...
10864B	  %9451:vgpr_32 = V_LSHRREV_B32_e32 3, %999:vgpr_32(s32), implicit $exec
10880B	  undef %8962.sub0:vreg_64_align2 = V_OR_B32_e32 $sgpr18, %9451:vgpr_32, implicit $exec
...
14112B	  undef %8965.sub0:vreg_64_align2 = V_OR3_B32_e64 %9451:vgpr_32, $sgpr18, 64, implicit $exec
...
43888B	  %9454:vgpr_32 = V_AND_B32_e32 48, %999:vgpr_32(s32), implicit $exec
43904B	  %9470:vgpr_32 = nuw nsw V_LSHLREV_B32_e32 6, %999:vgpr_32(s32), implicit $exec
43920B	  %9467:vgpr_32 = nuw nsw V_LSHLREV_B32_e32 2, %999:vgpr_32(s32), implicit $exec
...
43984B	  undef %9458.sub0:av_64_align2 = COPY %9457.sub0:vreg_64_align2
43992B	  SI_SPILL_AV64_SAVE %9458:av_64_align2, %stack.5, $sgpr32, 0, implicit $exec :: (store (s64) into %stack.5, align 4, addrspace 5)
44008B	  SI_SPILL_AV32_SAVE %9449:vgpr_32, %stack.4, $sgpr32, 0, implicit $exec :: (store (s32) into %stack.4, addrspace 5)
44016B	  SI_SPILL_AV64_SAVE %9447:vreg_64_align2, %stack.3, $sgpr32, 0, implicit $exec :: (store (s64) into %stack.3, align 4, addrspace 5)
44024B	  SI_SPILL_AV32_SAVE %9445:vgpr_32, %stack.2, $sgpr32, 0, implicit $exec :: (store (s32) into %stack.2, addrspace 5)
44032B	  SI_SPILL_AV32_SAVE %9443:vgpr_32, %stack.1, $sgpr32, 0, implicit $exec :: (store (s32) into %stack.1, addrspace 5)
44040B	  SI_SPILL_AV32_SAVE %9441:vgpr_32, %stack.0, $sgpr32, 0, implicit $exec :: (store (s32) into %stack.0, addrspace 5)
...
44088B	  %3920:vgpr_32 = V_MUL_U32_U24_e32 272, %9464:vgpr_32, implicit $exec
44096B	  %196:vgpr_32 = V_XOR_B32_e32 %3920:vgpr_32, %9454:vgpr_32, implicit $exec
44104B	  %197:vgpr_32 = V_XOR_B32_e32 64, %196:vgpr_32, implicit $exec
44112B	  %198:vgpr_32 = V_XOR_B32_e32 128, %196:vgpr_32, implicit $exec
44120B	  %199:vgpr_32 = V_XOR_B32_e32 192, %196:vgpr_32, implicit $exec
44128B	  %3927:vgpr_32 = V_AND_B32_e32 28672, %9470:vgpr_32, implicit $exec
44144B	  %3929:vgpr_32 = disjoint V_LSHL_OR_B32_e64 %9464:vgpr_32, 7, %3927:vgpr_32, implicit $exec
44160B	  %3931:vgpr_32 = V_BITOP3_B32_e64 %49:vgpr_32, %9454:vgpr_32, killed $sgpr2, 108, implicit $exec
...
45168B	  %4168:vgpr_32 = V_ADD_U32_e32 $sgpr13, %9467:vgpr_32, implicit $exec
...
49520B	  %8422.sub1:vreg_64_align2 = COPY %9447.sub1:vreg_64_align2
49552B	  %8420.sub1:vreg_64_align2 = COPY %9447.sub1:vreg_64_align2
49584B	  %8418.sub1:vreg_64_align2 = COPY %9447.sub1:vreg_64_align2
49616B	  %9457.sub1:vreg_64_align2 = COPY %9447.sub1:vreg_64_align2
...
64208B	bb.59.Flow:
	; predecessors: %bb.58
	  ...
	  liveins: $sgpr5, $sgpr0_sgpr1, $sgpr6_sgpr7, $sgpr18_sgpr19:0x000000000000000F, $sgpr22_sgpr23:0x000000000000000F, $sgpr34_sgpr35:0x000000000000000F, $sgpr8_sgpr9_sgpr10_sgpr11:0x00000000000000FF, $sgpr16_sgpr17_sgpr18_sgpr19:0x000000000000000F, $sgpr20_sgpr21_sgpr22_sgpr23:0x000000000000000F
64216B	  %9439:vgpr_32 = V_LSHRREV_B32_e32 4, %999:vgpr_32(s32), implicit $exec
66264B	  %9438:vgpr_32 = COPY %9439:vgpr_32
66268B	  %9441:vgpr_32 = SI_SPILL_AV32_RESTORE %stack.0, $sgpr32, 0, implicit $exec :: (load (s32) from %stack.0, addrspace 5)
66276B	  %9443:vgpr_32 = SI_SPILL_AV32_RESTORE %stack.1, $sgpr32, 0, implicit $exec :: (load (s32) from %stack.1, addrspace 5)
66280B	  %9445:vgpr_32 = SI_SPILL_AV32_RESTORE %stack.2, $sgpr32, 0, implicit $exec :: (load (s32) from %stack.2, addrspace 5)
66288B	  %9447:vreg_64_align2 = SI_SPILL_AV64_RESTORE %stack.3, $sgpr32, 0, implicit $exec :: (load (s64) from %stack.3, align 4, addrspace 5)
66292B	  %9449:vgpr_32 = SI_SPILL_AV32_RESTORE %stack.4, $sgpr32, 0, implicit $exec :: (load (s32) from %stack.4, addrspace 5)
66296B	  %9452:vgpr_32 = V_LSHRREV_B32_e32 3, %999:vgpr_32(s32), implicit $exec
66300B	  %9451:vgpr_32 = COPY %9452:vgpr_32
66308B	  %9455:vgpr_32 = V_AND_B32_e32 48, %999:vgpr_32(s32), implicit $exec
66316B	  %9454:vgpr_32 = COPY %9455:vgpr_32
66324B	  %9459:av_64_align2 = SI_SPILL_AV64_RESTORE %stack.5, $sgpr32, 0, implicit $exec :: (load (s64) from %stack.5, align 4, addrspace 5)
66332B	  undef %9457.sub0:vreg_64_align2 = COPY %9459.sub0:av_64_align2
66340B	  %9465:vgpr_32 = V_AND_B32_e32 15, %999:vgpr_32(s32), implicit $exec
66348B	  %9464:vgpr_32 = COPY %9465:vgpr_32
66356B	  undef %9462.sub0:vreg_64_align2 = V_LSHLREV_B32_e32 4, %9464:vgpr_32, implicit $exec
66364B	  undef %9461.sub0:vreg_64_align2 = COPY %9462.sub0:vreg_64_align2
66372B	  %9468:vgpr_32 = nuw nsw V_LSHLREV_B32_e32 2, %999:vgpr_32(s32), implicit $exec
66380B	  %9467:vgpr_32 = COPY %9468:vgpr_32
66388B	  %9471:vgpr_32 = nuw nsw V_LSHLREV_B32_e32 6, %999:vgpr_32(s32), implicit $exec
66396B	  %9470:vgpr_32 = COPY %9471:vgpr_32
...
66428B	  S_BARRIER
66436B	  %741:vgpr_32 = V_AND_B32_e32 14, %999:vgpr_32(s32), implicit $exec
66452B	  $vcc = S_AND_B64 $exec, killed renamable $sgpr6_sgpr7, implicit-def dead $scc
66460B	  %742:vgpr_32 = nuw nsw V_LSHLREV_B32_e32 3, %741:vgpr_32, implicit $exec
...
68560B	  %4412:vgpr_32 = nuw nsw V_LSHLREV_B32_e32 7, %9464:vgpr_32, implicit $exec
68576B	  %4416:vgpr_32 = V_AND_B32_e32 28672, %9470:vgpr_32, implicit $exec
68592B	  %4417:vgpr_32 = V_XOR_B32_e32 %742:vgpr_32, %9454:vgpr_32, implicit $exec
...
68784B	  %4432:vgpr_32 = V_MUL_U32_U24_e32 272, %9464:vgpr_32, implicit $exec
68800B	  %4433:vgpr_32 = V_XOR_B32_e32 %4432:vgpr_32, %9454:vgpr_32, implicit $exec
...
82080B	  %4863:vgpr_32 = V_AND_B32_e32 1932, %9467:vgpr_32, implicit $exec
...
82224B	  undef %8126.sub0:vreg_64_align2 = V_OR_B32_e32 $sgpr12, %9461.sub0:vreg_64_align2, implicit $exec
...
82304B	  renamable $sgpr0_sgpr1 = V_CMP_LT_I64_e64 %9457:vreg_64_align2, %8413:vreg_64_align2, implicit $exec
...
129872B	  S_BARRIER
129888B	  %7213:vgpr_32 = nuw nsw V_LSHLREV_B32_e32 4, %9454:vgpr_32, implicit $exec
129904B	  %7215:vgpr_32 = V_AND_B32_e32 48, %9451:vgpr_32, implicit $exec
...
130896B	  %8432:vgpr_32 = V_MUL_LO_U32_e64 %9449:vgpr_32, $sgpr5, implicit $exec
130912B	  %8474:vgpr_32 = V_MUL_LO_U32_e64 %9447.sub0:vreg_64_align2, $sgpr5, implicit $exec
130928B	  %7291:vgpr_32 = V_MUL_LO_U32_e64 $sgpr5, %9438:vgpr_32, implicit $exec
130944B	  %7293:vgpr_32 = V_MUL_LO_U32_e64 $sgpr5, %9441:vgpr_32, implicit $exec
130960B	  %7295:vgpr_32 = V_MUL_LO_U32_e64 $sgpr5, %9443:vgpr_32, implicit $exec
130976B	  %7297:vgpr_32 = V_MUL_LO_U32_e64 killed $sgpr5, %9445:vgpr_32, implicit $exec
