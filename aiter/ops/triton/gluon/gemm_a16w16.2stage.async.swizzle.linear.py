...
def _gemm_a16_w16_kernel(
    ...
    #    order=[1, 0],
    #)
    #blocked_a: gl.constexpr = gl.SwizzledSharedLayout(
    #    vec=8, per_phase=2, max_phase=8, order=[1, 0]
    #)
    blocked_a: gl.constexpr = gl.DistributedLinearLayout(
        reg_bases=((0,1),(0,2), (0,4), (8,32), (128, 0)),
        lane_bases=((0, 8), (0, 16), (0, 32), (1, 0), (2, 8), (4, 16)),
        warp_bases=((16, 0), (32, 0), (64, 0)),
        block_bases=[],
        shape=[256, 64],
    )
    #slice_a1: gl.constexpr = gl.DistributedLinearLayout(
    #    reg_bases=((0,0),(0,0), (0,0), (8,0), (128, 0)),
    #    lane_bases=((0, 0), (0, 0), (0, 0), (1, 0), (2, 0), (4, 0)),
    #    warp_bases=((16, 0), (32, 0), (64, 0)),
    #    block_bases=[],
    #    shape=[256, 1],
    #)
    #slice_a0: gl.constexpr = gl.DistributedLinearLayout(
    #    reg_bases=((0,1),(0,2), (0,4), (0,32), (0, 0)),
    #    lane_bases=((0, 8), (0, 16), (0, 32), (0, 0), (0, 8), (0, 16)),
    ...
    if split_k_start < K:
        ...
        # offs_ak = gl.arange(0, BLOCK_SIZE_K, layout=slice_a0)
        ...
        # offs_am = (pid_m * BLOCK_SIZE_M + gl.arange(0, BLOCK_SIZE_M, layout=slice_a1)) % M
        ...
        # prologue
        gl.amd.cdna4.async_copy.buffer_load_to_shared(smem_a, a_ptr, a_offs)
        gl.amd.cdna4.async_copy.buffer_load_to_shared(smem_b, b_ptr, b_offs)
