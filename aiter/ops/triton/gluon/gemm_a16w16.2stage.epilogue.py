...
def _gemm_a16_w16_kernel(
    ...
    if split_k_start < K:
        ...
        #    order=[1, 0],
        #)
        blocked_c: gl.constexpr = gl.DistributedLinearLayout(
            reg_bases=((0,1),(0,2), (0,4), (16,0), (0, 128), (64, 0), (128, 0)),
        ...
        c_tmp = accumulator.to(c_ptr.type.element_ty)
        c = gl.convert_layout(c_tmp, layout=blocked_c)
        ...
        offs_cm = pid_m * BLOCK_SIZE_M + gl.arange(0, BLOCK_SIZE_M, layout=gl.SliceLayout(1, blocked_c))
